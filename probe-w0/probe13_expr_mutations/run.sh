...
if [ $rc -eq 0 ]; then
  echo "EXPR MUTATION-KILL PASS ✓  (25 baselines close + kills flip 1->0 [incl. P1 poison-channel + b77 IfCtor/AssertQueryTactus arm kills + b78 mut-call frame kills + b79 Loop kills at full strength + b80 expected-typ channel + b81 scope-binder kills])"
else
