...
noncomputable def f (n : Nat) : Nat :=
  n
theorem _tactus_assert_probe_at_candB_9_12_1 (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (y : Int) (h_y_bound : 0 ≤ y ∧ y < 18446744073709551616) (h_req0 : Int.toNat x * f (Int.toNat y) = f 0) :
    /- @rust:/tmp/ch5probe/candB.rs:9:12 -/ Int.toNat x * f (Int.toNat y) = f 0 := by
  intros; assumption 
theorem _tactus_ensures_probe_2 (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (y : Int) (h_y_bound : 0 ≤ y ∧ y < 18446744073709551616) (h_req0 : Int.toNat x * f (Int.toNat y) = f 0) :
    Int.toNat x * f (Int.toNat y) = f 0 → Int.toNat x * f (Int.toNat y) = f 0 → True := by
  tactus_auto
end candB
