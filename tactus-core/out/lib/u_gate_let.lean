...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_gate_let_at_lib_3677_13_1 (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (v : Int) (h_v_bound : 0 ≤ v ∧ v < 18446744073709551616) (t : Tactus.Box lib.FrameList) :
    /- @rust:lib.rs:3677:13 -/ lib.has_plain_flet (lib.FrameList.FLet x v t) = 1 := by
