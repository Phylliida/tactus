...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_cso_cons_split_hoist_at_lib_4058_13_5 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    /- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → (let tmp__1 := lib.RawExpList.Cons h t;
                                                ∀ (_tactus_ret_1 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv lib.FrameList.FNil st tmp__1 = lib.obligs_safe he tmp__1 st) → (∀ (_tactus_ret_2 : Unit), (∀ (st : Int → Int), lib.obligs_safe he (lib.RawExpList.Cons h t) st = ((Tactus.Ref.mk he).deref (lib.render_exp h.deref) st ∧ lib.obligs_safe he t.deref st)) → (∀ (_tactus_ret_3 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv lib.FrameList.FNil st h.deref = (Tactus.Ref.mk he).deref (lib.render_exp h.deref) st) → (∀ (_tactus_ret_4 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv lib.FrameList.FNil st t.deref = lib.obligs_safe he t.deref st) → (/- @rust:lib.rs:4058:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st (lib.RawExpList.Cons h t) = (lib.close_sem_e_hoist hp he lv f st h.deref ∧ lib.close_sem_obligs_hoist hp he lv f st t.deref)))))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_termination_cso_cons_split_hoist_at_lib_4073_13_9 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → /- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → (let x := tmp___0.FBind_val0;
                                                                                             let ty := tmp___0.FBind_val1;
                                                                                             let tl := tmp___0.FBind_val2;
                                                                                             let tmp__2 := lib.RawExpList.Cons h t;
                                                                                             ∀ (_tactus_ret_6 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FBind x ty tl) st tmp__2 = (∀ (n : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st x n) tmp__2)) → (∀ (_tactus_ret_7 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv (lib.FrameList.FBind x ty tl) st h.deref = (∀ (n : Int), lib.close_sem_e_hoist hp he lv tl.deref (lib.upd st x n) h.deref)) → (∀ (_tactus_ret_8 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FBind x ty tl) st t.deref = (∀ (n : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st x n) t.deref)) → /- @rust:lib.rs:4073:13 -/ lib.FrameList.height tl.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height tl.deref = lib.FrameList.height decrease_init0 ∧ False))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_postcondition_cso_cons_split_hoist_at_lib_4058_13_11 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → /- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → (let x := tmp___0.FBind_val0;
                                                                                             let ty := tmp___0.FBind_val1;
                                                                                             let tl := tmp___0.FBind_val2;
                                                                                             let tmp__2 := lib.RawExpList.Cons h t;
                                                                                             ∀ (_tactus_ret_6 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FBind x ty tl) st tmp__2 = (∀ (n : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st x n) tmp__2)) → (∀ (_tactus_ret_7 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv (lib.FrameList.FBind x ty tl) st h.deref = (∀ (n : Int), lib.close_sem_e_hoist hp he lv tl.deref (lib.upd st x n) h.deref)) → (∀ (_tactus_ret_8 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FBind x ty tl) st t.deref = (∀ (n : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st x n) t.deref)) → lib.FrameList.height tl.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height tl.deref = lib.FrameList.height decrease_init0 ∧ False → (∀ (_tactus_ret_10 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv tl.deref st (lib.RawExpList.Cons h t) = (lib.close_sem_e_hoist hp he lv tl.deref st h.deref ∧ lib.close_sem_obligs_hoist hp he lv tl.deref st t.deref)) → (/- @rust:lib.rs:4058:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st (lib.RawExpList.Cons h t) = (lib.close_sem_e_hoist hp he lv f st h.deref ∧ lib.close_sem_obligs_hoist hp he lv f st t.deref)))))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_termination_cso_cons_split_hoist_at_lib_4079_13_15 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → /- @rust:lib.rs:4075:9 -/ tmp___0.isFHyp → (let hn := tmp___0.FHyp_val0;
                                                                                                                                         let hh := tmp___0.FHyp_val1;
                                                                                                                                         let tl := tmp___0.FHyp_val2;
                                                                                                                                         let tmp__3 := lib.RawExpList.Cons h t;
                                                                                                                                         ∀ (_tactus_ret_12 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FHyp hn hh tl) st tmp__3 = (∀ (v : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st hn v) tmp__3)) → (∀ (_tactus_ret_13 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv (lib.FrameList.FHyp hn hh tl) st h.deref = (∀ (v : Int), lib.close_sem_e_hoist hp he lv tl.deref (lib.upd st hn v) h.deref)) → (∀ (_tactus_ret_14 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FHyp hn hh tl) st t.deref = (∀ (v : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st hn v) t.deref)) → /- @rust:lib.rs:4079:13 -/ lib.FrameList.height tl.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height tl.deref = lib.FrameList.height decrease_init0 ∧ False))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_postcondition_cso_cons_split_hoist_at_lib_4058_13_17 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → /- @rust:lib.rs:4075:9 -/ tmp___0.isFHyp → (let hn := tmp___0.FHyp_val0;
                                                                                                                                         let hh := tmp___0.FHyp_val1;
                                                                                                                                         let tl := tmp___0.FHyp_val2;
                                                                                                                                         let tmp__3 := lib.RawExpList.Cons h t;
                                                                                                                                         ∀ (_tactus_ret_12 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FHyp hn hh tl) st tmp__3 = (∀ (v : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st hn v) tmp__3)) → (∀ (_tactus_ret_13 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv (lib.FrameList.FHyp hn hh tl) st h.deref = (∀ (v : Int), lib.close_sem_e_hoist hp he lv tl.deref (lib.upd st hn v) h.deref)) → (∀ (_tactus_ret_14 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FHyp hn hh tl) st t.deref = (∀ (v : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st hn v) t.deref)) → lib.FrameList.height tl.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height tl.deref = lib.FrameList.height decrease_init0 ∧ False → (∀ (_tactus_ret_16 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv tl.deref st (lib.RawExpList.Cons h t) = (lib.close_sem_e_hoist hp he lv tl.deref st h.deref ∧ lib.close_sem_obligs_hoist hp he lv tl.deref st t.deref)) → (/- @rust:lib.rs:4058:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st (lib.RawExpList.Cons h t) = (lib.close_sem_e_hoist hp he lv f st h.deref ∧ lib.close_sem_obligs_hoist hp he lv f st t.deref)))))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_termination_cso_cons_split_hoist_at_lib_4085_13_21 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:4075:9 -/ tmp___0.isFHyp → /- @rust:lib.rs:4081:9 -/ tmp___0.isFLet → (let x := tmp___0.FLet_val0;
                                                                                                                                                                                     let v := tmp___0.FLet_val1;
                                                                                                                                                                                     let tl := tmp___0.FLet_val2;
                                                                                                                                                                                     let tmp__4 := lib.RawExpList.Cons h t;
                                                                                                                                                                                     ∀ (_tactus_ret_18 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLet x v tl) st tmp__4 = lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) tmp__4) → (∀ (_tactus_ret_19 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv (lib.FrameList.FLet x v tl) st h.deref = lib.close_sem_e_hoist hp he lv tl.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) h.deref) → (∀ (_tactus_ret_20 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLet x v tl) st t.deref = lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) t.deref) → /- @rust:lib.rs:4085:13 -/ lib.FrameList.height tl.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height tl.deref = lib.FrameList.height decrease_init0 ∧ False))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_postcondition_cso_cons_split_hoist_at_lib_4058_13_23 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:4075:9 -/ tmp___0.isFHyp → /- @rust:lib.rs:4081:9 -/ tmp___0.isFLet → (let x := tmp___0.FLet_val0;
                                                                                                                                                                                     let v := tmp___0.FLet_val1;
  ...
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_termination_cso_cons_split_hoist_at_lib_4091_13_27 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:4075:9 -/ tmp___0.isFHyp → ¬/- @rust:lib.rs:4081:9 -/ tmp___0.isFLet → (let x := tmp___0.FLetH_val0;
                                                                                                                                                                                      ...
                                                                                                                                                                                      ∀ (_tactus_ret_24 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLetH x ty v en ep tl) st tmp__5 = (∀ (a : Int) (b : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd (lib.upd st x a) en b) tmp__5)) → (∀ (_tactus_ret_25 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv (lib.FrameList.FLetH x ty v en ep tl) st h.deref = (∀ (a : Int) (b : Int), lib.close_sem_e_hoist hp he lv tl.deref (lib.upd (lib.upd st x a) en b) h.deref)) → (∀ (_tactus_ret_26 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLetH x ty v en ep tl) st t.deref = (∀ (a : Int) (b : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd (lib.upd st x a) en b) t.deref)) → /- @rust:lib.rs:4091:13 -/ lib.FrameList.height tl.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height tl.deref = lib.FrameList.height decrease_init0 ∧ False))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
theorem _tactus_postcondition_cso_cons_split_hoist_at_lib_4058_13_29 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (h : Tactus.Box lib.RawExp) (t : Tactus.Box lib.RawExpList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:4063:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:4069:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:4075:9 -/ tmp___0.isFHyp → ¬/- @rust:lib.rs:4081:9 -/ tmp___0.isFLet → (let x := tmp___0.FLetH_val0;
                                                                                                                                                                                      let ty := tmp___0.FLetH_val1;
                                                                                                                                                                                      ...
                                                                                                                                                                                      let tl := tmp___0.FLetH_val5;
                                                                                                                                                                                      let tmp__5 := lib.RawExpList.Cons h t;
                                                                                                                                                                                      ∀ (_tactus_ret_24 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLetH x ty v en ep tl) st tmp__5 = (∀ (a : Int) (b : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd (lib.upd st x a) en b) tmp__5)) → (∀ (_tactus_ret_25 : Unit), (∀ (st : Int → Int), lib.close_sem_e_hoist hp he lv (lib.FrameList.FLetH x ty v en ep tl) st h.deref = (∀ (a : Int) (b : Int), lib.close_sem_e_hoist hp he lv tl.deref (lib.upd (lib.upd st x a) en b) h.deref)) → (∀ (_tactus_ret_26 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLetH x ty v en ep tl) st t.deref = (∀ (a : Int) (b : Int), lib.close_sem_obligs_hoist hp he lv tl.deref (lib.upd (lib.upd st x a) en b) t.deref)) → lib.FrameList.height tl.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height tl.deref = lib.FrameList.height decrease_init0 ∧ False → (∀ (_tactus_ret_28 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv tl.deref st (lib.RawExpList.Cons h t) = (lib.close_sem_e_hoist hp he lv tl.deref st h.deref ∧ lib.close_sem_obligs_hoist hp he lv tl.deref st t.deref)) → (/- @rust:lib.rs:4058:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st (lib.RawExpList.Cons h t) = (lib.close_sem_e_hoist hp he lv f st h.deref ∧ lib.close_sem_obligs_hoist hp he lv f st t.deref)))))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc, forall_and]))
