...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_gate_bind_at_lib_3671_13_1 (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (ty : Int) (h_ty_bound : 0 ≤ ty ∧ ty < 18446744073709551616) (t : Tactus.Box lib.FrameList) :
    /- @rust:lib.rs:3671:13 -/ lib.has_plain_flet (lib.FrameList.FBind x ty t) = lib.has_plain_flet t.deref := by
