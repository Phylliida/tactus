...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_cew_nil_at_lib_3695_13_1 (ob : lib.RawExp) :
    /- @rust:lib.rs:3695:13 -/ lib.close_e_wrap lib.FrameList.FNil ob = lib.GoalData.LeafE (lib.render_exp ob) := by
