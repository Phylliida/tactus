...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_wp_seq_at_lib_3790_13_1 (f : lib.FrameList) (a : Tactus.Box lib.StmData) (b : Tactus.Box lib.StmData) :
    /- @rust:lib.rs:3790:13 -/ lib.wp_stm f (lib.StmData.Seq a b) = lib.goals_append (lib.wp_stm f a.deref) (lib.wp_stm (lib.frame_after f a.deref) b.deref) := by
