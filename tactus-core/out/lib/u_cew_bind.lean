...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_cew_bind_at_lib_3698_13_1 (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (ty : Int) (h_ty_bound : 0 ≤ ty ∧ ty < 18446744073709551616) (t : Tactus.Box lib.FrameList) (ob : lib.RawExp) :
    /- @rust:lib.rs:3698:13 -/ lib.close_e_wrap (lib.FrameList.FBind x ty t) ob = lib.GoalData.All x ty (Tactus.Box.mk (lib.close_e_wrap t.deref ob)) := by
