...
-- tactus-closer: user
theorem _tactus_postcondition_frame_append_fnil_right_at_lib_6434_13_2 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    /- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → (let tmp__1 := lib.FrameList.FNil;
                                                            ∀ (_tactus_ret_1 : Unit), lib.frame_append lib.FrameList.FNil tmp__1 = tmp__1 → /- @rust:tactus-core/lib.rs:6434:13 -/ lib.frame_append f lib.FrameList.FNil = f) := by
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_termination_frame_append_fnil_right_at_lib_6443_13_4 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → /- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → (let id := tmp___0.FBind_val0;
                                                                                                                     let typ := tmp___0.FBind_val1;
                                                                                                                     let t := tmp___0.FBind_val2;
                                                                                                                     let tmp__2 := lib.FrameList.FNil;
                                                                                                                     ∀ (_tactus_ret_3 : Unit), lib.frame_append (lib.FrameList.FBind id typ t) tmp__2 = lib.FrameList.FBind id typ (Tactus.Box.mk (lib.frame_append t.deref tmp__2)) → /- @rust:tactus-core/lib.rs:6443:13 -/ lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False) := by
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_postcondition_frame_append_fnil_right_at_lib_6434_13_6 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → /- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → (let id := tmp___0.FBind_val0;
                                                                                                                     let typ := tmp___0.FBind_val1;
...
theorem _tactus_postcondition_frame_append_fnil_right_at_lib_6434_13_10 (f : lib.FrameList) :
  ...
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_termination_frame_append_fnil_right_at_lib_6451_13_12 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → ¬/- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → ¬/- @rust:tactus-core/lib.rs:6445:9 -/ tmp___0.isFHyp → /- @rust:tactus-core/lib.rs:6449:9 -/ tmp___0.isFLetH → (let x := tmp___0.FLetH_val0;
  ...
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_postcondition_frame_append_fnil_right_at_lib_6434_13_14 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → ¬/- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → ¬/- @rust:tactus-core/lib.rs:6445:9 -/ tmp___0.isFHyp → /- @rust:tactus-core/lib.rs:6449:9 -/ tmp___0.isFLetH → (let x := tmp___0.FLetH_val0;
                                                                                                                                                                                                                                      let ty := tmp___0.FLetH_val1;
  ...
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_termination_frame_append_fnil_right_at_lib_6455_13_16 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → ¬/- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → ¬/- @rust:tactus-core/lib.rs:6445:9 -/ tmp___0.isFHyp → ¬/- @rust:tactus-core/lib.rs:6449:9 -/ tmp___0.isFLetH → /- @rust:tactus-core/lib.rs:6453:9 -/ tmp___0.isFLet → (let id := tmp___0.FLet_val0;
                                                                                                                                                                                                                                                                                              let v := tmp___0.FLet_val1;
                                                                                                                                                                                                                                                                                              let t := tmp___0.FLet_val2;
                                                                                                                                                                                                                                                                                              let tmp__5 := lib.FrameList.FNil;
                                                                                                                                                                                                                                                                                              ∀ (_tactus_ret_15 : Unit), lib.frame_append (lib.FrameList.FLet id v t) tmp__5 = lib.FrameList.FLet id v (Tactus.Box.mk (lib.frame_append t.deref tmp__5)) → /- @rust:tactus-core/lib.rs:6455:13 -/ lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False) := by
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_postcondition_frame_append_fnil_right_at_lib_6434_13_18 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → ¬/- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → ¬/- @rust:tactus-core/lib.rs:6445:9 -/ tmp___0.isFHyp → ¬/- @rust:tactus-core/lib.rs:6449:9 -/ tmp___0.isFLetH → /- @rust:tactus-core/lib.rs:6453:9 -/ tmp___0.isFLet → (let id := tmp___0.FLet_val0;
                                                                                                                                                                                                                                                                                              let v := tmp___0.FLet_val1;
  ...
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_termination_frame_append_fnil_right_at_lib_6459_13_20 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → ¬/- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → ¬/- @rust:tactus-core/lib.rs:6445:9 -/ tmp___0.isFHyp → ¬/- @rust:tactus-core/lib.rs:6449:9 -/ tmp___0.isFLetH → ¬/- @rust:tactus-core/lib.rs:6453:9 -/ tmp___0.isFLet → /- @rust:tactus-core/lib.rs:6457:9 -/ tmp___0.isFLetR → (let id := tmp___0.FLetR_val0;
  ...
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_postcondition_frame_append_fnil_right_at_lib_6434_13_22 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → ¬/- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → ¬/- @rust:tactus-core/lib.rs:6445:9 -/ tmp___0.isFHyp → ¬/- @rust:tactus-core/lib.rs:6449:9 -/ tmp___0.isFLetH → ¬/- @rust:tactus-core/lib.rs:6453:9 -/ tmp___0.isFLet → /- @rust:tactus-core/lib.rs:6457:9 -/ tmp___0.isFLetR → (let id := tmp___0.FLetR_val0;
                                                                                                                                                                                                                                                                                                                                                       let v := tmp___0.FLetR_val1;
  ...
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_termination_frame_append_fnil_right_at_lib_6463_13_24 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
  ...
  first | (intros <;> cases f <;> omega) | (intros <;> cases f <;> with_reducible rfl) | tactus_auto | (intros <;> simp_all (config := { zetaDelta := true }) [and_assoc])
-- tactus-closer: user
theorem _tactus_postcondition_frame_append_fnil_right_at_lib_6434_13_26 (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:tactus-core/lib.rs:6438:9 -/ tmp___0.isFNil → ¬/- @rust:tactus-core/lib.rs:6441:9 -/ tmp___0.isFBind → ¬/- @rust:tactus-core/lib.rs:6445:9 -/ tmp___0.isFHyp → ¬/- @rust:tactus-core/lib.rs:6449:9 -/ tmp___0.isFLetH → ¬/- @rust:tactus-core/lib.rs:6453:9 -/ tmp___0.isFLet → ¬/- @rust:tactus-core/lib.rs:6457:9 -/ tmp___0.isFLetR → (let t := tmp___0.FUserCloser_val0;
                                                                                                                                                                                                                                                                                                                                                        let tmp__7 := lib.FrameList.FNil;
