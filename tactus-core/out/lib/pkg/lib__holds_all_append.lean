...
-- tactus-closer: user
theorem _tactus_postcondition_holds_all_append_at_lib_4443_13_3 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (a : lib.GoalList) (b : lib.GoalList) (st : Int → Int) :
    let decrease_init0 := a;
    let tmp___0 := a;
    /- @rust:tactus-core/lib.rs:4448:9 -/ tmp___0.isNil → (∀ (_tactus_ret_1 : Unit), lib.goals_append lib.GoalList.Nil b = b → (∀ (_tactus_ret_2 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True) → /- @rust:tactus-core/lib.rs:4443:13 -/ lib.holds_all hp he lv (lib.goals_append a b) st = (lib.holds_all hp he lv a st ∧ lib.holds_all hp he lv b st))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
-- tactus-closer: user
theorem _tactus_termination_holds_all_append_at_lib_4456_13_7 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (a : lib.GoalList) (b : lib.GoalList) (st : Int → Int) :
    let decrease_init0 := a;
    let tmp___0 := a;
    ¬/- @rust:tactus-core/lib.rs:4448:9 -/ tmp___0.isNil → (let g := tmp___0.Cons_val0;
                                                            ...
                                                            ∀ (_tactus_ret_4 : Unit), lib.goals_append (lib.GoalList.Cons g t) b = lib.GoalList.Cons g (Tactus.Box.mk (lib.goals_append t.deref b)) → (∀ (_tactus_ret_5 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv (lib.GoalList.Cons g t) st = (lib.holds hp he lv g.deref st ∧ lib.holds_all hp he lv t.deref st)) → (let tmp__1 := lib.goals_append t.deref b;
                                                                                                                                                                                                                                                                                                                                                                                  ∀ (_tactus_ret_6 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv (lib.GoalList.Cons g (Tactus.Box.mk tmp__1)) st = (lib.holds hp he lv g.deref st ∧ lib.holds_all hp he lv tmp__1 st)) → /- @rust:tactus-core/lib.rs:4456:13 -/ lib.GoalList.height t.deref < lib.GoalList.height decrease_init0 ∨ lib.GoalList.height t.deref = lib.GoalList.height decrease_init0 ∧ False))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
-- tactus-closer: user
theorem _tactus_postcondition_holds_all_append_at_lib_4443_13_9 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (a : lib.GoalList) (b : lib.GoalList) (st : Int → Int) :
    let decrease_init0 := a;
    let tmp___0 := a;
    ¬/- @rust:tactus-core/lib.rs:4448:9 -/ tmp___0.isNil → (let g := tmp___0.Cons_val0;
                                                            let t := tmp___0.Cons_val1;
