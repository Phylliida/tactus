...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_esf_aqnl_at_lib_3612_13_1 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (b : Tactus.Box lib.StmData) :
    /- @rust:lib.rs:3612:13 -/ ∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.AssertQueryNl b) st = lib.exec_safe_f hp he lv (lib.strip_hyps f) b.deref st := by
  first | rfl | decide | omega | (intro _; first | rfl | decide | omega) | (simp_all only [Classical.not_forall, Decidable.not_not, Int.add_emod_left, Int.cast_ofNat_Int, Int.natCast_add, Int.neg_add_emod_self, Int.ofNat_eq_coe, Int.ofNat_zero_le, Int.sub_zero, Int.toNat_natCast_add_one, Int.zero_add, Int.zero_sub, Int.mul_add, Int.add_mul, Int.toNat_zero, Int.toNat_one, Int.add_sub_cancel, Nat.add_le_add_iff_right, Nat.add_left_cancel_iff, Nat.add_zero, Nat.le_add_left, Nat.le_add_right, Nat.le_refl, Nat.not_le, Nat.not_lt, Nat.reduceLeDiff, Nat.sub_le_iff_le_add, Nat.zero_add, Nat.zero_le, Nat.mul_add, Nat.add_mul, Nat.add_sub_cancel, and_imp, and_self, and_true, eq_iff_iff, forall_const, forall_eq, ge_iff_le, gt_iff_lt, iff_true, imp_false, imp_self, implies_true, not_and, not_exists, not_false_eq_true, Classical.not_imp, not_or, not_true_eq_false, true_and] <;> omega) | (intro st; intros; simp_all +zetaDelta only [Classical.not_forall, Decidable.not_not, Int.add_emod_left, Int.cast_ofNat_Int, Int.natCast_add, Int.neg_add_emod_self, Int.ofNat_eq_coe, Int.ofNat_zero_le, Int.sub_zero, Int.toNat_natCast_add_one, Int.zero_add, Int.zero_sub, Int.mul_add, Int.add_mul, Int.toNat_zero, Int.toNat_one, Int.add_sub_cancel, Nat.add_le_add_iff_right, Nat.add_left_cancel_iff, Nat.add_zero, Nat.le_add_left, Nat.le_add_right, Nat.le_refl, Nat.not_le, Nat.not_lt, Nat.reduceLeDiff, Nat.sub_le_iff_le_add, Nat.zero_add, Nat.zero_le, Nat.mul_add, Nat.add_mul, Nat.add_sub_cancel, and_imp, and_self, and_true, eq_iff_iff, forall_const, forall_eq, ge_iff_le, gt_iff_lt, iff_true, imp_false, imp_self, implies_true, not_and, not_exists, not_false_eq_true, Classical.not_imp, not_or, not_true_eq_false, true_and, true_or, or_true, if_true, if_false, reduceCtorEq, lib.ExprData.App.injEq, lib.ExprData.AppN.injEq, lib.ExprData.Atom.injEq, lib.ExprData.BinOp.injEq, lib.ExprData.Cast.injEq, lib.ExprData.Exists.injEq, lib.ExprData.FieldProj.injEq, lib.ExprData.Forall.injEq, lib.ExprData.Ite.injEq, lib.ExprData.Let.injEq, lib.ExprData.Lit.injEq, lib.ExprData.LitBool.injEq, lib.ExprData.Match.injEq, lib.ExprData.Not.injEq, lib.ExprData.SpanMark.injEq, lib.FrameList.FBind.injEq, lib.FrameList.FHyp.injEq, lib.FrameList.FLet.injEq, lib.FrameList.FLetH.injEq, lib.StmData.Assert.injEq, lib.StmData.AssertQueryNl.injEq, lib.StmData.Assign.injEq, lib.StmData.Assume.injEq, lib.StmData.Call.injEq, lib.StmData.DeadEnd.injEq, lib.StmData.If.injEq, lib.StmData.Loop.injEq, lib.StmData.Ret.injEq, lib.StmData.Seq.injEq] <;> omega)
