...
theorem lib.ref_wp_call_pass_through :
    lib.goals_eq (lib.wp_stm (lib.FrameList.FHyp 100 (Tactus.Box.mk lib.FrameList.FNil)) (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Call (Tactus.Box.mk (lib.LeafList.Cons 7 (Tactus.Box.mk lib.LeafList.Nil))) (Tactus.Box.mk (lib.FrameList.FHyp 9 (Tactus.Box.mk (lib.FrameList.FLet 8 10 (Tactus.Box.mk lib.FrameList.FNil))))))) (Tactus.Box.mk (lib.StmData.Assert 11 12)))) (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Imp 100 (Tactus.Box.mk (lib.GoalData.Leaf 7)))) (Tactus.Box.mk (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Imp 100 (Tactus.Box.mk (lib.GoalData.Imp 9 (Tactus.Box.mk (lib.GoalData.Let 8 10 (Tactus.Box.mk (lib.GoalData.Leaf 11)))))))) (Tactus.Box.mk lib.GoalList.Nil)))) = 1 ∧ lib.goals_eq (lib.wp_stm (lib.FrameList.FHyp 100 (Tactus.Box.mk lib.FrameList.FNil)) (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Call (Tactus.Box.mk (lib.LeafList.Cons 7 (Tactus.Box.mk lib.LeafList.Nil))) (Tactus.Box.mk (lib.FrameList.FBind 8 1 (Tactus.Box.mk (lib.FrameList.FHyp 9 (Tactus.Box.mk (lib.FrameList.FHyp 13 (Tactus.Box.mk lib.FrameList.FNil))))))))) (Tactus.Box.mk (lib.StmData.Assert 11 12)))) (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Imp 100 (Tactus.Box.mk (lib.GoalData.Leaf 7)))) (Tactus.Box.mk (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Imp 100 (Tactus.Box.mk (lib.GoalData.All 8 1 (Tactus.Box.mk (lib.GoalData.Imp 9 (Tactus.Box.mk (lib.GoalData.Imp 13 (Tactus.Box.mk (lib.GoalData.Leaf 11)))))))))) (Tactus.Box.mk lib.GoalList.Nil)))) = 1 ∧ lib.goals_eq (lib.wp_stm (lib.FrameList.FHyp 100 (Tactus.Box.mk lib.FrameList.FNil)) (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Call (Tactus.Box.mk (lib.LeafList.Cons 7 (Tactus.Box.mk lib.LeafList.Nil))) (Tactus.Box.mk (lib.FrameList.FHyp 9 (Tactus.Box.mk (lib.FrameList.FLet 8 10 (Tactus.Box.mk lib.FrameList.FNil))))))) (Tactus.Box.mk (lib.StmData.Assert 11 12)))) (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Imp 100 (Tactus.Box.mk (lib.GoalData.Leaf 7)))) (Tactus.Box.mk (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Imp 100 (Tactus.Box.mk (lib.GoalData.Imp 9 (Tactus.Box.mk (lib.GoalData.Let 8 99 (Tactus.Box.mk (lib.GoalData.Leaf 11)))))))) (Tactus.Box.mk lib.GoalList.Nil)))) = 0 := by
  decide 
