...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_ceh_bind_at_lib_3715_13_1 (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (ty : Int) (h_ty_bound : 0 ≤ ty ∧ ty < 18446744073709551616) (t : Tactus.Box lib.FrameList) (ob : lib.RawExp) :
    /- @rust:lib.rs:3715:13 -/ lib.close_e_hoist (lib.FrameList.FBind x ty t) ob = lib.GoalData.All x ty (Tactus.Box.mk (lib.close_e_hoist t.deref ob)) := by
