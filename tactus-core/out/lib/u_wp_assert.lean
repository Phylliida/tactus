...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_wp_assert_at_lib_3742_13_1 (f : lib.FrameList) (o : lib.RawExp) (h : Int) (h_h_bound : 0 ≤ h ∧ h < 18446744073709551616) :
    /- @rust:lib.rs:3742:13 -/ lib.wp_stm f (lib.StmData.Assert o h) = lib.GoalList.Cons (Tactus.Box.mk (lib.close_e f o)) (Tactus.Box.mk lib.GoalList.Nil) := by
