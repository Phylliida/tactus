...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_fapp_fbind_at_lib_4290_13_1 (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (ty : Int) (h_ty_bound : 0 ≤ ty ∧ ty < 18446744073709551616) (t : Tactus.Box lib.FrameList) (g : lib.FrameList) :
    /- @rust:lib.rs:4290:13 -/ lib.frame_append (lib.FrameList.FBind x ty t) g = lib.FrameList.FBind x ty (Tactus.Box.mk (lib.frame_append t.deref g)) := by
