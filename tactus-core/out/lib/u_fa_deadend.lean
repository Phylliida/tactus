...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_fa_deadend_at_lib_4281_13_1 (f : lib.FrameList) (b : Tactus.Box lib.StmData) :
    /- @rust:lib.rs:4281:13 -/ lib.frame_after f (lib.StmData.DeadEnd b) = f := by
