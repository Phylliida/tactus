...
noncomputable def lib.close_sem_obligs_hoist (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (l : lib.RawExpList) : Prop :=
  match f with | lib.FrameList.FNil => lib.obligs_safe he l st | lib.FrameList.FBind x _ty t => ∀ (n : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st x n) l | lib.FrameList.FHyp hn _h t => ∀ (n : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st hn n) l | lib.FrameList.FLet x v t => lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) l | lib.FrameList.FLetH x _ty _v en _ep t => ∀ (a : Int) (b : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd (lib.upd st x a) en b) l
termination_by structural f
noncomputable def lib.close_sem_obligs (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (l : lib.RawExpList) : Prop :=
  if lib.has_plain_flet f = 1 then lib.close_sem_obligs_wrap hp he lv f st l else lib.close_sem_obligs_hoist hp he lv f st l
noncomputable def lib.exec_safe_f (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) : Prop :=
  match s with | lib.StmData.Assert o _h => lib.close_sem_e hp he lv f st o | lib.StmData.Assume _e => True | lib.StmData.Assign _x _rhs => True | lib.StmData.Call reqs _ => lib.close_sem_obligs hp he lv f st reqs.deref | lib.StmData.DeadEnd b => lib.exec_safe_f hp he lv f b.deref st | lib.StmData.AssertQueryNl b => lib.exec_safe_f hp he lv (lib.strip_hyps f) b.deref st | lib.StmData.Ret es rb => lib.close_sem_obligs hp he lv (lib.ret_frame f rb) st es.deref | lib.StmData.If c nc t e => lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref st | lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann _ d_old_name d_old_val decrease_oblig body => let mframe := lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       let endf := lib.frame_after mframe body.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ((lib.close_sem_obligs hp he lv f st inv_obligs.deref ∧ lib.exec_safe_f hp he lv mframe body.deref st) ∧ lib.close_sem_obligs hp he lv endf st inv_obligs.deref) ∧ lib.close_sem_e hp he lv endf st decrease_oblig | lib.StmData.Skip => True | lib.StmData.Seq a b => lib.exec_safe_f hp he lv f a.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_after f a.deref) b.deref st
termination_by structural s
...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_6 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    /- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → (let o := tmp___0.Assert_val0;
                                                  let h := tmp___0.Assert_val1;
                                                  ∀ (_tactus_ret_1 : Unit), lib.wp_stm f (lib.StmData.Assert o h) = lib.GoalList.Cons (Tactus.Box.mk (lib.close_e f o)) (Tactus.Box.mk lib.GoalList.Nil) → (let tmp__1 := lib.close_e f o;
                                                                                                                                                                                                            let tmp__2 := lib.GoalList.Nil;
                                                                                                                                                                                                            ∀ (_tactus_ret_2 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv (lib.GoalList.Cons (Tactus.Box.mk tmp__1) (Tactus.Box.mk tmp__2)) st = (lib.holds hp he lv tmp__1 st ∧ lib.holds_all hp he lv tmp__2 st)) → (∀ (_tactus_ret_3 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True) → (∀ (_tactus_ret_4 : Unit), (∀ (st : Int → Int), lib.holds hp he lv (lib.close_e f o) st = lib.close_sem_e hp he lv f st o) → (∀ (_tactus_ret_5 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Assert o h) st = lib.close_sem_e hp he lv f st o) → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_10 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → /- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → (let e := tmp___0.Assume_val0;
                                                                                                ∀ (_tactus_ret_7 : Unit), lib.wp_stm f (lib.StmData.Assume e) = lib.GoalList.Nil → (∀ (_tactus_ret_8 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True) → (∀ (_tactus_ret_9 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Assume e) st = True) → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_14 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → /- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → (let x := tmp___0.Assign_val0;
                                                                                                                                              let rhs := tmp___0.Assign_val1;
                                                                                                                                              ∀ (_tactus_ret_11 : Unit), lib.wp_stm f (lib.StmData.Assign x rhs) = lib.GoalList.Nil → (∀ (_tactus_ret_12 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True) → (∀ (_tactus_ret_13 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Assign x rhs) st = True) → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_18 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → /- @rust:lib.rs:4182:9 -/ tmp___0.isCall → (let reqs := tmp___0.Call_reqs;
                                                                                                                                                                                          let post := tmp___0.Call_post;
                                                                                                                                                                                          ∀ (_tactus_ret_15 : Unit), lib.wp_stm f (lib.StmData.Call reqs post) = lib.close_each_e f reqs.deref → (∀ (_tactus_ret_16 : Unit), lib.holds_all hp he lv (lib.close_each_e f reqs.deref) st = lib.close_sem_obligs hp he lv f st reqs.deref → (∀ (_tactus_ret_17 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Call reqs post) st = lib.close_sem_obligs hp he lv f st reqs.deref) → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_wp_stm_sound_at_lib_4190_13_21 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → /- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → (let b := tmp___0.DeadEnd_val0;
                                                                                                                                                                                                                                         ∀ (_tactus_ret_19 : Unit), lib.wp_stm f (lib.StmData.DeadEnd b) = lib.wp_stm f b.deref → (∀ (_tactus_ret_20 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.DeadEnd b) st = lib.exec_safe_f hp he lv f b.deref st) → /- @rust:lib.rs:4190:13 -/ lib.StmData.height b.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height b.deref = lib.StmData.height decrease_init0 ∧ False)) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_23 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → /- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → (let b := tmp___0.DeadEnd_val0;
                                                                                                                                                                                                                                         ∀ (_tactus_ret_19 : Unit), lib.wp_stm f (lib.StmData.DeadEnd b) = lib.wp_stm f b.deref → (∀ (_tactus_ret_20 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.DeadEnd b) st = lib.exec_safe_f hp he lv f b.deref st) → lib.StmData.height b.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height b.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_22 : Unit), lib.holds_all hp he lv (lib.wp_stm f b.deref) st = lib.exec_safe_f hp he lv f b.deref st → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_wp_stm_sound_at_lib_4195_13_26 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → /- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → (let b := tmp___0.AssertQueryNl_val0;
                                                                                                                                                                                                                                                                                              ∀ (_tactus_ret_24 : Unit), lib.wp_stm f (lib.StmData.AssertQueryNl b) = lib.wp_stm (lib.strip_hyps f) b.deref → (∀ (_tactus_ret_25 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.AssertQueryNl b) st = lib.exec_safe_f hp he lv (lib.strip_hyps f) b.deref st) → (let tmp__3 := lib.strip_hyps f;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        /- @rust:lib.rs:4195:13 -/ lib.StmData.height b.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height b.deref = lib.StmData.height decrease_init0 ∧ False))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_28 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → /- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → (let b := tmp___0.AssertQueryNl_val0;
                                                                                                                                                                                                                                                                                              ∀ (_tactus_ret_24 : Unit), lib.wp_stm f (lib.StmData.AssertQueryNl b) = lib.wp_stm (lib.strip_hyps f) b.deref → (∀ (_tactus_ret_25 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.AssertQueryNl b) st = lib.exec_safe_f hp he lv (lib.strip_hyps f) b.deref st) → (let tmp__3 := lib.strip_hyps f;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        lib.StmData.height b.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height b.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_27 : Unit), lib.holds_all hp he lv (lib.wp_stm tmp__3 b.deref) st = lib.exec_safe_f hp he lv tmp__3 b.deref st → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st)))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_32 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → /- @rust:lib.rs:4197:9 -/ tmp___0.isRet → (let es := tmp___0.Ret_val0;
                                                                                                                                                                                                                                                                                                                                         let rb := tmp___0.Ret_val1;
                                                                                                                                                                                                                                                                                                                                         ∀ (_tactus_ret_29 : Unit), lib.wp_stm f (lib.StmData.Ret es rb) = lib.close_each_e (lib.ret_frame f rb) es.deref → (let tmp__4 := lib.ret_frame f rb;
                                                                                                                                                                                                                                                                                                                                                                                                                                                             ∀ (_tactus_ret_30 : Unit), lib.holds_all hp he lv (lib.close_each_e tmp__4 es.deref) st = lib.close_sem_obligs hp he lv tmp__4 st es.deref → (∀ (_tactus_ret_31 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Ret es rb) st = lib.close_sem_obligs hp he lv (lib.ret_frame f rb) st es.deref) → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_wp_stm_sound_at_lib_4208_13_36 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → /- @rust:lib.rs:4202:9 -/ tmp___0.isIf → (let c := tmp___0.If_val0;
                                                                                                                                                                                                                                                                                                                                                                                   let nc := tmp___0.If_val1;
                                                                                                                                                                                                                                                                                                                                                                                   let t := tmp___0.If_val2;
                                                                                                                                                                                                                                                                                                                                                                                   let e := tmp___0.If_val3;
                                                                                                                                                                                                                                                                                                                                                                                   ∀ (_tactus_ret_33 : Unit), lib.wp_stm f (lib.StmData.If c nc t e) = lib.goals_append (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref) (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref) → (∀ (_tactus_ret_34 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.If c nc t e) st = (lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref st)) → (let tmp__5 := lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     let tmp__6 := lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ∀ (_tactus_ret_35 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__5 tmp__6) st = (lib.holds_all hp he lv tmp__5 st ∧ lib.holds_all hp he lv tmp__6 st) → (let tmp__7 := lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      /- @rust:lib.rs:4208:13 -/ lib.StmData.height t.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height t.deref = lib.StmData.height decrease_init0 ∧ False)))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_wp_stm_sound_at_lib_4209_13_38 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → /- @rust:lib.rs:4202:9 -/ tmp___0.isIf → (let c := tmp___0.If_val0;
                                                                                                                                                                                                                                                                                                                                                                                   let nc := tmp___0.If_val1;
                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                   ∀ (_tactus_ret_33 : Unit), lib.wp_stm f (lib.StmData.If c nc t e) = lib.goals_append (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref) (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref) → (∀ (_tactus_ret_34 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.If c nc t e) st = (lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref st)) → (let tmp__5 := lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     let tmp__6 := lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ∀ (_tactus_ret_35 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__5 tmp__6) st = (lib.holds_all hp he lv tmp__5 st ∧ lib.holds_all hp he lv tmp__6 st) → (let tmp__7 := lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      lib.StmData.height t.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height t.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_37 : Unit), lib.holds_all hp he lv (lib.wp_stm tmp__7 t.deref) st = lib.exec_safe_f hp he lv tmp__7 t.deref st → (let tmp__8 := lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /- @rust:lib.rs:4209:13 -/ lib.StmData.height e.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height e.deref = lib.StmData.height decrease_init0 ∧ False)))))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_40 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → /- @rust:lib.rs:4202:9 -/ tmp___0.isIf → (let c := tmp___0.If_val0;
                                                                                                                                                                                                                                                                                                                                                                                   let nc := tmp___0.If_val1;
                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                   ∀ (_tactus_ret_33 : Unit), lib.wp_stm f (lib.StmData.If c nc t e) = lib.goals_append (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref) (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref) → (∀ (_tactus_ret_34 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.If c nc t e) st = (lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref st)) → (let tmp__5 := lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil))) t.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ∀ (_tactus_ret_35 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__5 tmp__6) st = (lib.holds_all hp he lv tmp__5 st ∧ lib.holds_all hp he lv tmp__6 st) → (let tmp__7 := lib.frame_append f (lib.FrameList.FHyp 0 c (Tactus.Box.mk lib.FrameList.FNil));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      lib.StmData.height t.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height t.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_37 : Unit), lib.holds_all hp he lv (lib.wp_stm tmp__7 t.deref) st = lib.exec_safe_f hp he lv tmp__7 t.deref st → (let tmp__8 := lib.frame_append f (lib.FrameList.FHyp 0 nc (Tactus.Box.mk lib.FrameList.FNil));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  lib.StmData.height e.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height e.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_39 : Unit), lib.holds_all hp he lv (lib.wp_stm tmp__8 e.deref) st = lib.exec_safe_f hp he lv tmp__8 e.deref st → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))))))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_wp_stm_sound_at_lib_4218_13_41 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → ¬/- @rust:lib.rs:4202:9 -/ tmp___0.isIf → /- @rust:lib.rs:4211:9 -/ tmp___0.isLoop → (let inv_hyps := tmp___0.Loop_inv_hyps;
                                                                                                                                                                                                                                                                                                                                                                                                                               let inv_obligs := tmp___0.Loop_inv_obligs;
                                                                                                                                                                                                                                                                                                                                                                                                                               let binders := tmp___0.Loop_binders;
                                                                                                                                                                                                                                                                                                                                                                                                                               let binder_bounds := tmp___0.Loop_binder_bounds;
                                                                                                                                                                                                                                                                                                                                                                                                                               let cond_name := tmp___0.Loop_cond_name;
                                                                                                                                                                                                                                                                                                                                                                                                                               let cond_ann := tmp___0.Loop_cond_ann;
                                                                                                                                                                                                                                                                                                                                                                                                                               let neg_cond_ann := tmp___0.Loop_neg_cond_ann;
                                                                                                                                                                                                                                                                                                                                                                                                                               let d_old_name := tmp___0.Loop_d_old_name;
                                                                                                                                                                                                                                                                                                                                                                                                                               let d_old_val := tmp___0.Loop_d_old_val;
                                                                                                                                                                                                                                                                                                                                                                                                                               let decrease_oblig := tmp___0.Loop_decrease_oblig;
                                                                                                                                                                                                                                                                                                                                                                                                                               let body := tmp___0.Loop_body;
                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                               /- @rust:lib.rs:4218:13 -/ lib.StmData.height body.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height body.deref = lib.StmData.height decrease_init0 ∧ False) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_53 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → ¬/- @rust:lib.rs:4202:9 -/ tmp___0.isIf → /- @rust:lib.rs:4211:9 -/ tmp___0.isLoop → (let inv_hyps := tmp___0.Loop_inv_hyps;
                                                                                                                                                                                                                                                                                                                                                                                                                               let inv_obligs := tmp___0.Loop_inv_obligs;
                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                               let body := tmp___0.Loop_body;
                                                                                                                                                                                                                                                                                                                                                                                                                               let tmp__9 := lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val;
                                                                                                                                                                                                                                                                                                                                                                                                                               lib.StmData.height body.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height body.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_42 : Unit), lib.holds_all hp he lv (lib.wp_stm tmp__9 body.deref) st = lib.exec_safe_f hp he lv tmp__9 body.deref st → (∀ (_tactus_ret_43 : Unit), lib.wp_stm f (lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann neg_cond_ann d_old_name d_old_val decrease_oblig body) = lib.goals_append (lib.close_each_e f inv_obligs.deref) (lib.goals_append (lib.wp_stm (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref) (lib.goals_append (lib.close_each_e (lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref) inv_obligs.deref) (lib.GoalList.Cons (Tactus.Box.mk (lib.close_e (lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref) decrease_oblig)) (Tactus.Box.mk lib.GoalList.Nil)))) → (∀ (_tactus_ret_44 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann neg_cond_ann d_old_name d_old_val decrease_oblig body) st = (((lib.close_sem_obligs hp he lv f st inv_obligs.deref ∧ lib.exec_safe_f hp he lv (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref st) ∧ lib.close_sem_obligs hp he lv (lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref) st inv_obligs.deref) ∧ lib.close_sem_e hp he lv (lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref) st decrease_oblig)) → (let tmp__10 := lib.close_each_e f inv_obligs.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ∀ (_tactus_ret_45 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__10 tmp__11) st = (lib.holds_all hp he lv tmp__10 st ∧ lib.holds_all hp he lv tmp__11 st) → (let tmp__12 := lib.wp_stm (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ∀ (_tactus_ret_46 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__12 tmp__13) st = (lib.holds_all hp he lv tmp__12 st ∧ lib.holds_all hp he lv tmp__13 st) → (let tmp__14 := lib.close_each_e (lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref) inv_obligs.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ∀ (_tactus_ret_47 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__14 tmp__15) st = (lib.holds_all hp he lv tmp__14 st ∧ lib.holds_all hp he lv tmp__15 st) → (∀ (_tactus_ret_48 : Unit), lib.holds_all hp he lv (lib.close_each_e f inv_obligs.deref) st = lib.close_sem_obligs hp he lv f st inv_obligs.deref → (let tmp__16 := lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ∀ (_tactus_ret_49 : Unit), lib.holds_all hp he lv (lib.close_each_e tmp__16 inv_obligs.deref) st = lib.close_sem_obligs hp he lv tmp__16 st inv_obligs.deref → (let tmp__17 := lib.close_e (lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref) decrease_oblig;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        let tmp__18 := lib.GoalList.Nil;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ∀ (_tactus_ret_50 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv (lib.GoalList.Cons (Tactus.Box.mk tmp__17) (Tactus.Box.mk tmp__18)) st = (lib.holds hp he lv tmp__17 st ∧ lib.holds_all hp he lv tmp__18 st)) → (∀ (_tactus_ret_51 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True) → (let tmp__19 := lib.frame_after (lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val) body.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ∀ (_tactus_ret_52 : Unit), (∀ (st : Int → Int), lib.holds hp he lv (lib.close_e tmp__19 decrease_oblig) st = lib.close_sem_e hp he lv tmp__19 st decrease_oblig) → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st)))))))))))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_57 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → ¬/- @rust:lib.rs:4202:9 -/ tmp___0.isIf → ¬/- @rust:lib.rs:4211:9 -/ tmp___0.isLoop → /- @rust:lib.rs:4240:9 -/ tmp___0.isSkip → (∀ (_tactus_ret_54 : Unit), lib.wp_stm f lib.StmData.Skip = lib.GoalList.Nil → (∀ (_tactus_ret_55 : Unit), (∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True) → (∀ (_tactus_ret_56 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f lib.StmData.Skip st = True) → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_wp_stm_sound_at_lib_4249_13_61 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → ¬/- @rust:lib.rs:4202:9 -/ tmp___0.isIf → ¬/- @rust:lib.rs:4211:9 -/ tmp___0.isLoop → ¬/- @rust:lib.rs:4240:9 -/ tmp___0.isSkip → (let a := tmp___0.Seq_val0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            let b := tmp___0.Seq_val1;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ∀ (_tactus_ret_58 : Unit), lib.wp_stm f (lib.StmData.Seq a b) = lib.goals_append (lib.wp_stm f a.deref) (lib.wp_stm (lib.frame_after f a.deref) b.deref) → (∀ (_tactus_ret_59 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Seq a b) st = (lib.exec_safe_f hp he lv f a.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_after f a.deref) b.deref st)) → (let tmp__20 := lib.wp_stm f a.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            let tmp__21 := lib.wp_stm (lib.frame_after f a.deref) b.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ∀ (_tactus_ret_60 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__20 tmp__21) st = (lib.holds_all hp he lv tmp__20 st ∧ lib.holds_all hp he lv tmp__21 st) → /- @rust:lib.rs:4249:13 -/ lib.StmData.height a.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height a.deref = lib.StmData.height decrease_init0 ∧ False))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_wp_stm_sound_at_lib_4250_13_63 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → ¬/- @rust:lib.rs:4202:9 -/ tmp___0.isIf → ¬/- @rust:lib.rs:4211:9 -/ tmp___0.isLoop → ¬/- @rust:lib.rs:4240:9 -/ tmp___0.isSkip → (let a := tmp___0.Seq_val0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            let b := tmp___0.Seq_val1;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ∀ (_tactus_ret_58 : Unit), lib.wp_stm f (lib.StmData.Seq a b) = lib.goals_append (lib.wp_stm f a.deref) (lib.wp_stm (lib.frame_after f a.deref) b.deref) → (∀ (_tactus_ret_59 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Seq a b) st = (lib.exec_safe_f hp he lv f a.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_after f a.deref) b.deref st)) → (let tmp__20 := lib.wp_stm f a.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            let tmp__21 := lib.wp_stm (lib.frame_after f a.deref) b.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ∀ (_tactus_ret_60 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__20 tmp__21) st = (lib.holds_all hp he lv tmp__20 st ∧ lib.holds_all hp he lv tmp__21 st) → lib.StmData.height a.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height a.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_62 : Unit), lib.holds_all hp he lv (lib.wp_stm f a.deref) st = lib.exec_safe_f hp he lv f a.deref st → (let tmp__22 := lib.frame_after f a.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /- @rust:lib.rs:4250:13 -/ lib.StmData.height b.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height b.deref = lib.StmData.height decrease_init0 ∧ False))))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_wp_stm_sound_at_lib_4161_13_65 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) :
    let decrease_init0 := s;
    let tmp___0 := s;
    ¬/- @rust:lib.rs:4165:9 -/ tmp___0.isAssert → ¬/- @rust:lib.rs:4172:9 -/ tmp___0.isAssume → ¬/- @rust:lib.rs:4177:9 -/ tmp___0.isAssign → ¬/- @rust:lib.rs:4182:9 -/ tmp___0.isCall → ¬/- @rust:lib.rs:4187:9 -/ tmp___0.isDeadEnd → ¬/- @rust:lib.rs:4192:9 -/ tmp___0.isAssertQueryNl → ¬/- @rust:lib.rs:4197:9 -/ tmp___0.isRet → ¬/- @rust:lib.rs:4202:9 -/ tmp___0.isIf → ¬/- @rust:lib.rs:4211:9 -/ tmp___0.isLoop → ¬/- @rust:lib.rs:4240:9 -/ tmp___0.isSkip → (let a := tmp___0.Seq_val0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            let b := tmp___0.Seq_val1;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ∀ (_tactus_ret_58 : Unit), lib.wp_stm f (lib.StmData.Seq a b) = lib.goals_append (lib.wp_stm f a.deref) (lib.wp_stm (lib.frame_after f a.deref) b.deref) → (∀ (_tactus_ret_59 : Unit), (∀ (st : Int → Int), lib.exec_safe_f hp he lv f (lib.StmData.Seq a b) st = (lib.exec_safe_f hp he lv f a.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_after f a.deref) b.deref st)) → (let tmp__20 := lib.wp_stm f a.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            let tmp__21 := lib.wp_stm (lib.frame_after f a.deref) b.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ∀ (_tactus_ret_60 : Unit), lib.holds_all hp he lv (lib.goals_append tmp__20 tmp__21) st = (lib.holds_all hp he lv tmp__20 st ∧ lib.holds_all hp he lv tmp__21 st) → lib.StmData.height a.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height a.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_62 : Unit), lib.holds_all hp he lv (lib.wp_stm f a.deref) st = lib.exec_safe_f hp he lv f a.deref st → (let tmp__22 := lib.frame_after f a.deref;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  lib.StmData.height b.deref < lib.StmData.height decrease_init0 ∨ lib.StmData.height b.deref = lib.StmData.height decrease_init0 ∧ False → (∀ (_tactus_ret_64 : Unit), lib.holds_all hp he lv (lib.wp_stm tmp__22 b.deref) st = lib.exec_safe_f hp he lv tmp__22 b.deref st → /- @rust:lib.rs:4161:13 -/ lib.holds_all hp he lv (lib.wp_stm f s) st = lib.exec_safe_f hp he lv f s st)))))) := by
  first | (intros <;> cases s <;> simp_all (config := { zetaDelta := true }) [and_assoc] <;> omega) | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
