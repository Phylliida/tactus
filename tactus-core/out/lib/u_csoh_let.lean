...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_csoh_let_at_lib_3580_13_1 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (x : Int) (h_x_bound : 0 ≤ x ∧ x < 18446744073709551616) (v : Int) (h_v_bound : 0 ≤ v ∧ v < 18446744073709551616) (t : Tactus.Box lib.FrameList) (l : lib.RawExpList) :
    /- @rust:lib.rs:3580:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLet x v t) st l = lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st x (lv v st)) l := by
