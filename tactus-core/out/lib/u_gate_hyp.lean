...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_gate_hyp_at_lib_3674_13_1 (n : Int) (h_n_bound : 0 ≤ n ∧ n < 18446744073709551616) (h : Int) (h_h_bound : 0 ≤ h ∧ h < 18446744073709551616) (t : Tactus.Box lib.FrameList) :
    /- @rust:lib.rs:3674:13 -/ lib.has_plain_flet (lib.FrameList.FHyp n h t) = lib.has_plain_flet t.deref := by
