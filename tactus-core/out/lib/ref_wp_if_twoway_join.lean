...
noncomputable def lib.cd19_sst : lib.StmData :=
  lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Assign 7 0)) (Tactus.Box.mk (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.If 8 9 (Tactus.Box.mk (lib.StmData.Assign 10 11)) (Tactus.Box.mk (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Assert 13 12)) (Tactus.Box.mk (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Assume 12)) (Tactus.Box.mk (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Assign 14 15)) (Tactus.Box.mk (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.Assert 17 16)) (Tactus.Box.mk (lib.StmData.Call (Tactus.Box.mk lib.LeafList.Nil) (Tactus.Box.mk (lib.FrameList.FHyp 20 (Tactus.Box.mk (lib.FrameList.FLet 18 19 (Tactus.Box.mk lib.FrameList.FNil))))))))))))))) (Tactus.Box.mk (lib.StmData.Assign 10 18)))))) (Tactus.Box.mk (lib.StmData.Ret (Tactus.Box.mk (lib.LeafList.Cons 5 (Tactus.Box.mk lib.LeafList.Nil))) (lib.RetBind.RetLet 6 10)))))
