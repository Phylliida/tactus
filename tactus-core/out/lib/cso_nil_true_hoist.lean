...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_cso_nil_true_hoist_at_lib_3968_13_3 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    /- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → (let tmp__1 := lib.RawExpList.Nil;
                                                ∀ (_tactus_ret_1 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv lib.FrameList.FNil st tmp__1 = lib.obligs_safe he tmp__1 st) → (∀ (_tactus_ret_2 : Unit), (∀ (st : Int → Int), lib.obligs_safe he lib.RawExpList.Nil st = True) → (/- @rust:lib.rs:3968:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st lib.RawExpList.Nil = True))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_cso_nil_true_hoist_at_lib_3978_13_5 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → /- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → (let x := tmp___0.FBind_val0;
                                                                                             let ty := tmp___0.FBind_val1;
                                                                                             let t := tmp___0.FBind_val2;
                                                                                             let tmp__2 := lib.RawExpList.Nil;
                                                                                             ∀ (_tactus_ret_4 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FBind x ty t) st tmp__2 = (∀ (n : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st x n) tmp__2)) → /- @rust:lib.rs:3978:13 -/ lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_cso_nil_true_hoist_at_lib_3968_13_7 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → /- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → (let x := tmp___0.FBind_val0;
                                                                                             let ty := tmp___0.FBind_val1;
                                                                                             let t := tmp___0.FBind_val2;
                                                                                             let tmp__2 := lib.RawExpList.Nil;
                                                                                             ∀ (_tactus_ret_4 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FBind x ty t) st tmp__2 = (∀ (n : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st x n) tmp__2)) → lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False → (∀ (_tactus_ret_6 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv t.deref st lib.RawExpList.Nil = True) → (/- @rust:lib.rs:3968:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st lib.RawExpList.Nil = True))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_cso_nil_true_hoist_at_lib_3982_13_9 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → /- @rust:lib.rs:3980:9 -/ tmp___0.isFHyp → (let hn := tmp___0.FHyp_val0;
                                                                                                                                         let h := tmp___0.FHyp_val1;
                                                                                                                                         let t := tmp___0.FHyp_val2;
                                                                                                                                         let tmp__3 := lib.RawExpList.Nil;
                                                                                                                                         ∀ (_tactus_ret_8 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FHyp hn h t) st tmp__3 = (∀ (v : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st hn v) tmp__3)) → /- @rust:lib.rs:3982:13 -/ lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_cso_nil_true_hoist_at_lib_3968_13_11 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → /- @rust:lib.rs:3980:9 -/ tmp___0.isFHyp → (let hn := tmp___0.FHyp_val0;
                                                                                                                                         let h := tmp___0.FHyp_val1;
                                                                                                                                         let t := tmp___0.FHyp_val2;
                                                                                                                                         let tmp__3 := lib.RawExpList.Nil;
                                                                                                                                         ∀ (_tactus_ret_8 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FHyp hn h t) st tmp__3 = (∀ (v : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st hn v) tmp__3)) → lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False → (∀ (_tactus_ret_10 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv t.deref st lib.RawExpList.Nil = True) → (/- @rust:lib.rs:3968:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st lib.RawExpList.Nil = True))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_cso_nil_true_hoist_at_lib_3986_13_13 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:3980:9 -/ tmp___0.isFHyp → /- @rust:lib.rs:3984:9 -/ tmp___0.isFLet → (let x := tmp___0.FLet_val0;
                                                                                                                                                                                     let v := tmp___0.FLet_val1;
                                                                                                                                                                                     let t := tmp___0.FLet_val2;
                                                                                                                                                                                     let tmp__4 := lib.RawExpList.Nil;
                                                                                                                                                                                     ∀ (_tactus_ret_12 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLet x v t) st tmp__4 = lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) tmp__4) → /- @rust:lib.rs:3986:13 -/ lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_cso_nil_true_hoist_at_lib_3968_13_15 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:3980:9 -/ tmp___0.isFHyp → /- @rust:lib.rs:3984:9 -/ tmp___0.isFLet → (let x := tmp___0.FLet_val0;
                                                                                                                                                                                     let v := tmp___0.FLet_val1;
                                                                                                                                                                                     let t := tmp___0.FLet_val2;
                                                                                                                                                                                     let tmp__4 := lib.RawExpList.Nil;
                                                                                                                                                                                     ∀ (_tactus_ret_12 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLet x v t) st tmp__4 = lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) tmp__4) → lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False → (∀ (_tactus_ret_14 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv t.deref st lib.RawExpList.Nil = True) → (/- @rust:lib.rs:3968:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st lib.RawExpList.Nil = True))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_termination_cso_nil_true_hoist_at_lib_3990_13_17 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:3980:9 -/ tmp___0.isFHyp → ¬/- @rust:lib.rs:3984:9 -/ tmp___0.isFLet → (let x := tmp___0.FLetH_val0;
                                                                                                                                                                                      ...
                                                                                                                                                                                      ∀ (_tactus_ret_16 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLetH x ty v en ep t) st tmp__5 = (∀ (a : Int) (b : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd (lib.upd st x a) en b) tmp__5)) → /- @rust:lib.rs:3990:13 -/ lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
theorem _tactus_postcondition_cso_nil_true_hoist_at_lib_3968_13_19 (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) :
    let decrease_init0 := f;
    let tmp___0 := f;
    ¬/- @rust:lib.rs:3972:9 -/ tmp___0.isFNil → ¬/- @rust:lib.rs:3976:9 -/ tmp___0.isFBind → ¬/- @rust:lib.rs:3980:9 -/ tmp___0.isFHyp → ¬/- @rust:lib.rs:3984:9 -/ tmp___0.isFLet → (let x := tmp___0.FLetH_val0;
                                                                                                                                                                                      let ty := tmp___0.FLetH_val1;
                                                                                                                                                                                      ...
                                                                                                                                                                                      let t := tmp___0.FLetH_val5;
                                                                                                                                                                                      let tmp__5 := lib.RawExpList.Nil;
                                                                                                                                                                                      ∀ (_tactus_ret_16 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv (lib.FrameList.FLetH x ty v en ep t) st tmp__5 = (∀ (a : Int) (b : Int), lib.close_sem_obligs_hoist hp he lv t.deref (lib.upd (lib.upd st x a) en b) tmp__5)) → lib.FrameList.height t.deref < lib.FrameList.height decrease_init0 ∨ lib.FrameList.height t.deref = lib.FrameList.height decrease_init0 ∧ False → (∀ (_tactus_ret_18 : Unit), (∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv t.deref st lib.RawExpList.Nil = True) → (/- @rust:lib.rs:3968:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st lib.RawExpList.Nil = True))) := by
  first | tactus_auto | (intros <;> tactus_case_split (simp_all (config := { zetaDelta := true }) [and_assoc]))
