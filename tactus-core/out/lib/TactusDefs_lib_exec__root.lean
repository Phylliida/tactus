...
noncomputable def lib.frame_len (f : lib.FrameList) : Nat :=
  match f with | lib.FrameList.FNil => 0 | lib.FrameList.FBind _id _typ t => 1 + lib.frame_len t.deref | lib.FrameList.FHyp _hn _h _p t => 1 + lib.frame_len t.deref | lib.FrameList.FLetH _x _ty _v _en _ep t => 1 + lib.frame_len t.deref | lib.FrameList.FLet _id _v t => 1 + lib.frame_len t.deref | lib.FrameList.FLetR _id _v t => 1 + lib.frame_len t.deref
termination_by structural f
noncomputable def lib.stm_size (s : lib.StmData) : Nat :=
  match s with | lib.StmData.Assert _o _hn _h _hp => 1 | lib.StmData.Assume _hn _e _hp => 1 | lib.StmData.Assign _d _r => 1 | lib.StmData.AssignH _x _ty _v _en _ep => 1 | lib.StmData.AssignR _x _v => 1 | lib.StmData.Call reqs post => 1 + lib.raw_exp_list_len reqs.deref + lib.frame_len post.deref | lib.StmData.DeadEnd b => 1 + lib.stm_size b.deref | lib.StmData.AssertQueryNl b _tq => 1 + lib.stm_size b.deref | lib.StmData.Ret es _rb => 1 + lib.raw_exp_list_len es.deref | lib.StmData.If _c _cn _nc _ncn _cp t e => 1 + lib.stm_size t.deref + lib.stm_size e.deref | lib.StmData.Loop inv_hyps inv_obligs binders _ _ _ _ _ _ _ body => 1 + lib.binder_len inv_hyps.deref + lib.raw_exp_list_len inv_obligs.deref + lib.binder_len binders.deref + lib.stm_size body.deref | lib.StmData.Skip => 1 | lib.StmData.Seq a b => 1 + lib.stm_size a.deref + lib.stm_size b.deref
...
noncomputable def lib.has_plain_flet (f : lib.FrameList) : Nat :=
  match f with | lib.FrameList.FNil => 0 | lib.FrameList.FBind _x _ty t => lib.has_plain_flet t.deref | lib.FrameList.FHyp _n _h _p t => lib.has_plain_flet t.deref | lib.FrameList.FLet _x _v _t => 1 | lib.FrameList.FLetH _x _ty _v _en _ep t => lib.has_plain_flet t.deref | lib.FrameList.FLetR _x _v t => lib.has_plain_flet t.deref
termination_by structural f
...
noncomputable def lib.gate_wrap (f : lib.FrameList) : Nat :=
  if lib.has_plain_flet f = 1 ∨ lib.has_poisoned_hyp f = 1 then 1 else 0
...
noncomputable def lib.has_let (f : lib.FrameList) : Nat :=
  match f with | lib.FrameList.FNil => 0 | lib.FrameList.FBind _id _typ t => lib.has_let t.deref | lib.FrameList.FHyp _hn _h _p t => lib.has_let t.deref | lib.FrameList.FLet _id _v _t => 1 | lib.FrameList.FLetH _id _ty _v _en _ep _t => 1 | lib.FrameList.FLetR _id _v _t => 1
termination_by structural f
...
noncomputable def lib.seed_binders_hyp_bounds (binders : lib.BinderList) (bounds : lib.ParamBoundList) : lib.FrameList :=
  match binders with | lib.BinderList.Nil => lib.FrameList.FNil | lib.BinderList.Cons id typ t => match bounds with | lib.ParamBoundList.Bound _hname prop bt => lib.FrameList.FBind id typ (Tactus.Box.mk (lib.FrameList.FHyp 0 prop 0 (Tactus.Box.mk (lib.seed_binders_hyp_bounds t.deref bt.deref)))) | lib.ParamBoundList.NoBound bt => lib.FrameList.FBind id typ (Tactus.Box.mk (lib.seed_binders_hyp_bounds t.deref bt.deref)) | lib.ParamBoundList.Nil => lib.FrameList.FBind id typ (Tactus.Box.mk (lib.seed_binders_hyp_bounds t.deref lib.ParamBoundList.Nil))
...
noncomputable def lib.wp_stm (f : lib.FrameList) (s : lib.StmData) : lib.GoalList :=
  match s with | lib.StmData.Assert o _hn _h _hp => lib.GoalList.Cons (Tactus.Box.mk (lib.close_e f o)) (Tactus.Box.mk lib.GoalList.Nil) | lib.StmData.Assume _hn _e _hp => lib.GoalList.Nil | lib.StmData.Assign _x _rhs => lib.GoalList.Nil | lib.StmData.AssignH _x _ty _v _en _ep => lib.GoalList.Nil | lib.StmData.AssignR _x _v => lib.GoalList.Nil | lib.StmData.Call reqs _ => lib.close_each_e f reqs.deref | lib.StmData.DeadEnd b => lib.wp_stm f b.deref | lib.StmData.AssertQueryNl b tq => lib.goals_append (lib.wp_stm (lib.strip_hyps f) b.deref) (lib.GoalList.Cons (Tactus.Box.mk (lib.close_e (lib.frame_after (lib.strip_hyps f) b.deref) tq)) (Tactus.Box.mk lib.GoalList.Nil)) | lib.StmData.Ret es rb => lib.close_each_e (lib.ret_frame f rb) es.deref | lib.StmData.If c cn nc ncn cp t e => lib.goals_append (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp cn c cp (Tactus.Box.mk lib.FrameList.FNil))) t.deref) (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp ncn nc cp (Tactus.Box.mk lib.FrameList.FNil))) e.deref) | lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann _ d_old_name d_old_val decrease_oblig body => let mframe := lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val;
...
noncomputable def lib.close_sem_obligs_res (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (l : lib.RawExpList) : Prop :=
  match f with | lib.FrameList.FNil => lib.obligs_safe he l st | lib.FrameList.FLetR x v t => lib.close_sem_obligs_res hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) l | lib.FrameList.FBind _x _ty t => lib.close_sem_obligs_res hp he lv t.deref st l | lib.FrameList.FHyp _hn _h _p t => lib.close_sem_obligs_res hp he lv t.deref st l | lib.FrameList.FLet _x _v t => lib.close_sem_obligs_res hp he lv t.deref st l | lib.FrameList.FLetH _x _ty _v _en _ep t => lib.close_sem_obligs_res hp he lv t.deref st l
termination_by structural f
...
noncomputable def lib.exec_safe_f (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) : Prop :=
  match s with | lib.StmData.Assert o _hn _h _hp => lib.close_sem_e hp he lv f st o | lib.StmData.Assume _hn _e _hp => True | lib.StmData.Assign _x _rhs => True | lib.StmData.AssignH _x _ty _v _en _ep => True | lib.StmData.AssignR _x _v => True | lib.StmData.Call reqs _ => lib.close_sem_obligs hp he lv f st reqs.deref | lib.StmData.DeadEnd b => lib.exec_safe_f hp he lv f b.deref st | lib.StmData.AssertQueryNl b tq => lib.exec_safe_f hp he lv (lib.strip_hyps f) b.deref st ∧ lib.close_sem_e hp he lv (lib.frame_after (lib.strip_hyps f) b.deref) st tq | lib.StmData.Ret es rb => lib.close_sem_obligs hp he lv (lib.ret_frame f rb) st es.deref | lib.StmData.If c cn nc ncn cp t e => lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp cn c cp (Tactus.Box.mk lib.FrameList.FNil))) t.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp ncn nc cp (Tactus.Box.mk lib.FrameList.FNil))) e.deref st | lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann _ d_old_name d_old_val decrease_oblig body => let mframe := lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               let endf := lib.frame_after mframe body.deref;
