...
termination_by structural f
noncomputable def lib.close_e_wrap_lead (f : lib.FrameList) (ob : lib.RawExp) : lib.GoalData :=
  match f with | lib.FrameList.FNil => lib.GoalData.LeafE (lib.render_exp ob) | lib.FrameList.FBind id typ t => lib.GoalData.All id typ (Tactus.Box.mk (lib.close_e_wrap_lead t.deref ob)) | lib.FrameList.FHyp hn h _p t => lib.GoalData.All hn h (Tactus.Box.mk (lib.close_e_wrap_lead t.deref ob)) | lib.FrameList.FLet id v t => lib.GoalData.Let id v (Tactus.Box.mk (lib.close_e_wrap t.deref ob)) | lib.FrameList.FLetH id _ty v _en _ep t => lib.GoalData.Let id v (Tactus.Box.mk (lib.close_e_wrap t.deref ob)) | lib.FrameList.FLetR id v t => lib.GoalData.Let id v (Tactus.Box.mk (lib.close_e_wrap t.deref ob)) | lib.FrameList.FUserCloser t => lib.close_e_wrap_lead t.deref ob
termination_by structural f
...
noncomputable def lib.close_e (f : lib.FrameList) (ob : lib.RawExp) : lib.GoalData :=
  if lib.gate_wrap f = 1 then lib.close_e_wrap_lead f ob else lib.close_e_hoist f ob
...
termination_by structural f
noncomputable def lib.close_sem_e_wrap_lead (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (o : lib.RawExp) : Prop :=
  match f with | lib.FrameList.FNil => (Tactus.Ref.mk he).deref (lib.render_exp o) st | lib.FrameList.FBind x _ty t => ∀ (n : Int), lib.close_sem_e_wrap_lead hp he lv t.deref (lib.upd st x n) o | lib.FrameList.FHyp hn _h _p t => ∀ (n : Int), lib.close_sem_e_wrap_lead hp he lv t.deref (lib.upd st hn n) o | lib.FrameList.FLet x v t => lib.close_sem_e_wrap hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) o | lib.FrameList.FLetH x _ty v _en _ep t => lib.close_sem_e_wrap hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) o | lib.FrameList.FLetR x v t => lib.close_sem_e_wrap hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) o | lib.FrameList.FUserCloser t => lib.close_sem_e_wrap_lead hp he lv t.deref st o
termination_by structural f
...
noncomputable def lib.close_sem_e (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (o : lib.RawExp) : Prop :=
  if lib.gate_wrap f = 1 then lib.close_sem_e_wrap_lead hp he lv f st o else lib.close_sem_e_hoist hp he lv f st o
...
termination_by structural f
noncomputable def lib.close_sem_obligs_wrap_lead (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (l : lib.RawExpList) : Prop :=
  match f with | lib.FrameList.FNil => lib.obligs_safe he l st | lib.FrameList.FBind x _ty t => ∀ (n : Int), lib.close_sem_obligs_wrap_lead hp he lv t.deref (lib.upd st x n) l | lib.FrameList.FHyp hn _h _p t => ∀ (n : Int), lib.close_sem_obligs_wrap_lead hp he lv t.deref (lib.upd st hn n) l | lib.FrameList.FLet x v t => lib.close_sem_obligs_wrap hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) l | lib.FrameList.FLetH x _ty v _en _ep t => lib.close_sem_obligs_wrap hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) l | lib.FrameList.FLetR x v t => lib.close_sem_obligs_wrap hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) l | lib.FrameList.FUserCloser t => lib.close_sem_obligs_wrap_lead hp he lv t.deref st l
termination_by structural f
...
noncomputable def lib.close_sem_obligs (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (l : lib.RawExpList) : Prop :=
  if lib.gate_wrap f = 1 then lib.close_sem_obligs_wrap_lead hp he lv f st l else lib.close_sem_obligs_hoist hp he lv f st l
