...
noncomputable def lib.wp_stm (f : lib.FrameList) (s : lib.StmData) : lib.GoalList :=
  match s with | lib.StmData.Assert o _h => lib.GoalList.Cons (Tactus.Box.mk (lib.close_e f o)) (Tactus.Box.mk lib.GoalList.Nil) | lib.StmData.Assume _e => lib.GoalList.Nil | lib.StmData.Assign _x _rhs => lib.GoalList.Nil | lib.StmData.Call reqs _ => lib.close_each_e f reqs.deref | lib.StmData.DeadEnd b => lib.wp_stm f b.deref | lib.StmData.AssertQueryNl b => lib.wp_stm (lib.strip_hyps f) b.deref | lib.StmData.Ret es rb => lib.close_each_e (lib.ret_frame f rb) es.deref | lib.StmData.If c nc t e => lib.goals_append (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp c (Tactus.Box.mk lib.FrameList.FNil))) t.deref) (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref) | lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann _ d_old_name d_old_val decrease_oblig body => let mframe := lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val;
...
noncomputable def lib.close_sem_e (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (o : lib.RawExp) : Prop :=
  match f with | lib.FrameList.FNil => (Tactus.Ref.mk he).deref (lib.render_exp o) st | lib.FrameList.FBind x _ty t => ∀ (n : Int), lib.close_sem_e hp he lv t.deref (lib.upd st x n) o | lib.FrameList.FHyp h t => (Tactus.Ref.mk hp).deref h st → lib.close_sem_e hp he lv t.deref st o | lib.FrameList.FLet x v t => lib.close_sem_e hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) o
termination_by structural f
noncomputable def lib.close_sem_obligs (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (st : Int → Int) (l : lib.RawExpList) : Prop :=
  match f with | lib.FrameList.FNil => lib.obligs_safe he l st | lib.FrameList.FBind x _ty t => ∀ (n : Int), lib.close_sem_obligs hp he lv t.deref (lib.upd st x n) l | lib.FrameList.FHyp h t => (Tactus.Ref.mk hp).deref h st → lib.close_sem_obligs hp he lv t.deref st l | lib.FrameList.FLet x v t => lib.close_sem_obligs hp he lv t.deref (lib.upd st x ((Tactus.Ref.mk lv).deref v st)) l
termination_by structural f
noncomputable def lib.exec_safe_f (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) : Prop :=
  match s with | lib.StmData.Assert o _h => lib.close_sem_e hp he lv f st o | lib.StmData.Assume _e => True | lib.StmData.Assign _x _rhs => True | lib.StmData.Call reqs _ => lib.close_sem_obligs hp he lv f st reqs.deref | lib.StmData.DeadEnd b => lib.exec_safe_f hp he lv f b.deref st | lib.StmData.AssertQueryNl b => lib.exec_safe_f hp he lv (lib.strip_hyps f) b.deref st | lib.StmData.Ret es rb => lib.close_sem_obligs hp he lv (lib.ret_frame f rb) st es.deref | lib.StmData.If c nc t e => lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp c (Tactus.Box.mk lib.FrameList.FNil))) t.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref st | lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann _ d_old_name d_old_val decrease_oblig body => let mframe := lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   let endf := lib.frame_after mframe body.deref;
