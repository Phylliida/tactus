...
noncomputable def lib.frame_after (f : lib.FrameList) (s : lib.StmData) : lib.FrameList :=
  match s with | lib.StmData.Assert e => lib.frame_append f (lib.FrameList.FHyp e (Tactus.Box.mk lib.FrameList.FNil)) | lib.StmData.Assume e => lib.frame_append f (lib.FrameList.FHyp e (Tactus.Box.mk lib.FrameList.FNil)) | lib.StmData.Assign x rhs => lib.frame_append f (lib.FrameList.FLet x rhs (Tactus.Box.mk lib.FrameList.FNil)) | lib.StmData.Call _ enss dest dest_typ => lib.frame_append f (lib.FrameList.FBind dest dest_typ (Tactus.Box.mk (lib.hyps_of_leaves enss.deref))) | lib.StmData.DeadEnd _b => f | lib.StmData.Ret _es => f | lib.StmData.If _c _nc _t _e => f | lib.StmData.Loop invs _ neg_cond binders _ => lib.frame_append f (lib.frame_append (lib.binders_to_frame binders.deref) (lib.frame_append (lib.hyps_of_leaves invs.deref) (lib.FrameList.FHyp neg_cond (Tactus.Box.mk lib.FrameList.FNil)))) | lib.StmData.Skip => f | lib.StmData.Seq a b => lib.frame_after (lib.frame_after f a.deref) b.deref
termination_by structural s
noncomputable def lib.wp_stm (f : lib.FrameList) (s : lib.StmData) : lib.GoalList :=
  match s with | lib.StmData.Assert e => lib.GoalList.Cons (Tactus.Box.mk (lib.close f e)) (Tactus.Box.mk lib.GoalList.Nil) | lib.StmData.Assume _e => lib.GoalList.Nil | lib.StmData.Assign _x _rhs => lib.GoalList.Nil | lib.StmData.Call reqs _ _ _ => lib.close_each f reqs.deref | lib.StmData.DeadEnd b => lib.wp_stm f b.deref | lib.StmData.Ret es => lib.close_each f es.deref | lib.StmData.If c nc t e => lib.goals_append (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp c (Tactus.Box.mk lib.FrameList.FNil))) t.deref) (lib.wp_stm (lib.frame_append f (lib.FrameList.FHyp nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref) | lib.StmData.Loop invs cond _ binders body => let mframe := lib.frame_append f (lib.frame_append (lib.binders_to_frame binders.deref) (lib.frame_append (lib.hyps_of_leaves invs.deref) (lib.FrameList.FHyp cond (Tactus.Box.mk lib.FrameList.FNil))));
