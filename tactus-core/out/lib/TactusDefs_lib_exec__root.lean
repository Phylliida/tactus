...
noncomputable def lib.exec_safe_f (hp : Int → (Int → Int) → Prop) (he : lib.ExprData → (Int → Int) → Prop) (lv : Int → (Int → Int) → Int) (f : lib.FrameList) (s : lib.StmData) (st : Int → Int) : Prop :=
  match s with | lib.StmData.Assert o _h => lib.close_sem_e hp he lv f st o | lib.StmData.Assume _e => True | lib.StmData.Assign _x _rhs => True | lib.StmData.Call reqs _ => lib.close_sem_obligs hp he lv f st reqs.deref | lib.StmData.DeadEnd b => lib.exec_safe_f hp he lv f b.deref st | lib.StmData.Ret es rb => lib.close_sem_obligs hp he lv (lib.ret_frame f rb) st es.deref | lib.StmData.If c nc t e => lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp c (Tactus.Box.mk lib.FrameList.FNil))) t.deref st ∧ lib.exec_safe_f hp he lv (lib.frame_append f (lib.FrameList.FHyp nc (Tactus.Box.mk lib.FrameList.FNil))) e.deref st | lib.StmData.Loop inv_hyps inv_obligs binders binder_bounds cond_name cond_ann _ d_old_name d_old_val decrease_oblig body => let mframe := lib.loop_maintain_frame f inv_hyps.deref binders.deref binder_bounds.deref cond_name cond_ann d_old_name d_old_val;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           let endf := lib.frame_after mframe body.deref;
