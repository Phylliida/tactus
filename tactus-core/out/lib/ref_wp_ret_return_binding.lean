...
theorem lib.ref_wp_ret_return_binding :
    lib.goals_eq (lib.wp_stm (lib.FrameList.FLet 16 23 (Tactus.Box.mk lib.FrameList.FNil)) (lib.StmData.Ret (Tactus.Box.mk (lib.LeafList.Cons 12 (Tactus.Box.mk lib.LeafList.Nil))) (lib.RetBind.RetLet 13 16))) (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Let 16 23 (Tactus.Box.mk (lib.GoalData.Let 13 16 (Tactus.Box.mk (lib.GoalData.Leaf 12)))))) (Tactus.Box.mk lib.GoalList.Nil)) = 1 ∧ lib.goals_eq (lib.wp_stm (lib.FrameList.FLet 16 23 (Tactus.Box.mk lib.FrameList.FNil)) (lib.StmData.Ret (Tactus.Box.mk (lib.LeafList.Cons 12 (Tactus.Box.mk lib.LeafList.Nil))) lib.RetBind.RetNone)) (lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.Let 16 23 (Tactus.Box.mk (lib.GoalData.Leaf 12)))) (Tactus.Box.mk lib.GoalList.Nil)) = 1 := by
  decide 
