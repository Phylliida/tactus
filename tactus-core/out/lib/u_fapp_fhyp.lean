...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_fapp_fhyp_at_lib_4294_13_1 (n : Int) (h_n_bound : 0 ≤ n ∧ n < 18446744073709551616) (h : Int) (h_h_bound : 0 ≤ h ∧ h < 18446744073709551616) (t : Tactus.Box lib.FrameList) (g : lib.FrameList) :
    /- @rust:lib.rs:4294:13 -/ lib.frame_append (lib.FrameList.FHyp n h t) g = lib.FrameList.FHyp n h (Tactus.Box.mk (lib.frame_append t.deref g)) := by
