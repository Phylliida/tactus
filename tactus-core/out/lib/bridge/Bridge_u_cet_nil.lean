...
-- tactus certificate (stage A) — crate `lib`, fn `u_cet_nil`
...
-- leaf 0: ⟦g⟧
-- leaf 1: ⟦lib.GoalData⟧
-- leaf 2: ⟦lib.close_e_tel lib.FrameList.FNil g = g⟧
-- leaf 3: ⟦/- @rust:tactus-core/lib.rs:5174:13 -/ lib.close_e_tel lib.FrameList.FNil g = g⟧
-- leaf 4: ⟦lib.close_e_tel⟧
-- leaf 5: ⟦lib.FrameList⟧

@[reducible] def cert_u_cet_nil_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cet_nil_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cet_nil_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cet_nil_at_lib_5174_13_1
@[reducible] def cert_u_cet_nil_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cet_nil_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cet_nil_ctx cert_u_cet_nil_sst) cert_u_cet_nil_goals = 1 := by decide
