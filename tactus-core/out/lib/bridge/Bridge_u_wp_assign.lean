...
-- tactus certificate (stage A) — crate `lib`, fn `u_wp_assign`
...
-- leaf 7: ⟦h_x_bound⟧
-- leaf 8: ⟦rhs⟧
-- leaf 9: ⟦0 ≤ rhs ∧ rhs < 18446744073709551616⟧
-- leaf 10: ⟦h_rhs_bound⟧
-- leaf 11: ⟦lib.wp_stm pp f (lib.StmData.Assign x rhs) = lib.GoalList.Nil⟧
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:5238:13 -/ lib.wp_stm pp f (lib.StmData.Assign x rhs) = lib.GoalList.Nil⟧
-- leaf 13: ⟦lib.wp_stm⟧
-- leaf 14: ⟦lib.GoalList⟧
-- leaf 15: ⟦lib.StmData⟧

@[reducible] def cert_u_wp_assign_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_wp_assign_sst : lib.StmData :=
...
example : lib.stm_size cert_u_wp_assign_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_wp_assign_at_lib_5238_13_1
@[reducible] def cert_u_wp_assign_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_wp_assign_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_wp_assign_ctx cert_u_wp_assign_sst) cert_u_wp_assign_goals = 1 := by decide
