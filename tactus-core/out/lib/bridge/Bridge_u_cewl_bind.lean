...
-- tactus certificate (stage A) — crate `lib`, fn `u_cewl_bind`
...
-- leaf 9: ⟦ob⟧
-- leaf 10: ⟦lib.RawExp⟧
-- leaf 11: ⟦lib.close_e_wrap_lead (lib.FrameList.FBind x ty t) ob = lib.GoalData.All x ty (Tactus.Box.mk (lib.close_e_wrap_lead t ob))⟧
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:5148:13 -/ lib.close_e_wrap_lead (lib.FrameList.FBind x ty t) ob = lib.GoalData.All x ty (Tactus.Box.mk (lib.close_e_wrap_lead t.deref ob))⟧
-- leaf 13: ⟦lib.close_e_wrap_lead⟧
-- leaf 14: ⟦lib.GoalData⟧
-- leaf 15: ⟦lib.FrameList⟧

@[reducible] def cert_u_cewl_bind_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cewl_bind_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cewl_bind_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cewl_bind_at_lib_5148_13_1
@[reducible] def cert_u_cewl_bind_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cewl_bind_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cewl_bind_ctx cert_u_cewl_bind_sst) cert_u_cewl_bind_goals = 1 := by decide
