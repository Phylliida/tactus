...
-- tactus certificate (stage A) — crate `lib`, fn `u_ceh_unfold`
...
-- leaf 2: ⟦ob⟧
-- leaf 3: ⟦lib.RawExp⟧
-- leaf 4: ⟦lib.close_e_hoist f ob = lib.close_e_tel f (lib.residue_fold_e f (lib.GoalData.LeafE (lib.render_exp ob)))⟧
-- leaf 5: ⟦/- @rust:tactus-core/lib.rs:5170:13 -/ lib.close_e_hoist f ob = lib.close_e_tel f (lib.residue_fold_e f (lib.GoalData.LeafE (lib.render_exp ob)))⟧
-- leaf 6: ⟦lib.close_e_hoist⟧
-- leaf 7: ⟦lib.GoalData⟧
-- leaf 8: ⟦lib.close_e_tel⟧
-- leaf 9: ⟦lib.residue_fold_e⟧

@[reducible] def cert_u_ceh_unfold_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_ceh_unfold_sst : lib.StmData :=
...
example : lib.stm_size cert_u_ceh_unfold_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_ceh_unfold_at_lib_5170_13_1
@[reducible] def cert_u_ceh_unfold_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_ceh_unfold_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_ceh_unfold_ctx cert_u_ceh_unfold_sst) cert_u_ceh_unfold_goals = 1 := by decide
