...
-- tactus certificate (stage A) — crate `lib`, fn `u_gate_leth`
...
-- leaf 18: ⟦lib.has_plain_flet (lib.FrameList.FLetH x ty v en ep t) = lib.has_plain_flet t⟧
-- leaf 19: ⟦/- @rust:tactus-core/lib.rs:5053:13 -/ lib.has_plain_flet (lib.FrameList.FLetH x ty v en ep t) = lib.has_plain_flet t.deref⟧
-- leaf 20: ⟦lib.has_plain_flet⟧
-- leaf 21: ⟦lib.FrameList⟧

@[reducible] def cert_u_gate_leth_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_gate_leth_sst : lib.StmData :=
...
example : lib.stm_size cert_u_gate_leth_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_gate_leth_at_lib_5053_13_1
@[reducible] def cert_u_gate_leth_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_gate_leth_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_gate_leth_ctx cert_u_gate_leth_sst) cert_u_gate_leth_goals = 1 := by decide
