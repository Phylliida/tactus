...
-- tactus certificate (stage A) — crate `lib`, fn `u_cet_ucl`
...
-- leaf 2: ⟦g⟧
-- leaf 3: ⟦lib.GoalData⟧
-- leaf 4: ⟦lib.close_e_tel (lib.FrameList.FUserCloser t) g = lib.close_e_tel t g⟧
-- leaf 5: ⟦/- @rust:tactus-core/lib.rs:5193:13 -/ lib.close_e_tel (lib.FrameList.FUserCloser t) g = lib.close_e_tel t.deref g⟧
-- leaf 6: ⟦lib.close_e_tel⟧
-- leaf 7: ⟦lib.FrameList⟧

@[reducible] def cert_u_cet_ucl_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cet_ucl_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cet_ucl_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cet_ucl_at_lib_5193_13_1
@[reducible] def cert_u_cet_ucl_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cet_ucl_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cet_ucl_ctx cert_u_cet_ucl_sst) cert_u_cet_ucl_goals = 1 := by decide
