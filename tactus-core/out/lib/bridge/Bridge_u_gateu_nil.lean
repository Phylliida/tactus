...
-- tactus certificate (stage A) — crate `lib`, fn `u_gateu_nil`
...
-- ── leaf table ──────────────────────────────────────────────
-- leaf 0: ⟦lib.has_user_closer lib.FrameList.FNil = 0⟧
-- leaf 1: ⟦/- @rust:tactus-core/lib.rs:5087:13 -/ lib.has_user_closer lib.FrameList.FNil = 0⟧
-- leaf 2: ⟦lib.has_user_closer⟧
-- leaf 3: ⟦lib.FrameList⟧

@[reducible] def cert_u_gateu_nil_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_gateu_nil_sst : lib.StmData :=
...
example : lib.stm_size cert_u_gateu_nil_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_gateu_nil_at_lib_5087_13_1
@[reducible] def cert_u_gateu_nil_goals : lib.GoalList :=
  lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.LeafE (lib.ExprData.Atom 1))) (Tactus.Box.mk lib.GoalList.Nil)

example : lib.goal_count cert_u_gateu_nil_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_gateu_nil_ctx cert_u_gateu_nil_sst) cert_u_gateu_nil_goals = 1 := by decide
