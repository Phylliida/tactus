...
-- tactus certificate (stage A) — crate `lib`, fn `u_gateu_let`
...
-- leaf 9: ⟦lib.has_user_closer (lib.FrameList.FLet x v t) = lib.has_user_closer t⟧
-- leaf 10: ⟦/- @rust:tactus-core/lib.rs:5096:13 -/ lib.has_user_closer (lib.FrameList.FLet x v t) = lib.has_user_closer t.deref⟧
-- leaf 11: ⟦lib.has_user_closer⟧
-- leaf 12: ⟦lib.FrameList⟧

@[reducible] def cert_u_gateu_let_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_gateu_let_sst : lib.StmData :=
...
example : lib.stm_size cert_u_gateu_let_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_gateu_let_at_lib_5096_13_1
@[reducible] def cert_u_gateu_let_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_gateu_let_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_gateu_let_ctx cert_u_gateu_let_sst) cert_u_gateu_let_goals = 1 := by decide
