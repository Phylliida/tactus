...
-- tactus certificate (stage A) — crate `lib`, fn `u_cew_hyp`
...
-- leaf 9: ⟦ob⟧
-- leaf 10: ⟦lib.RawExp⟧
-- leaf 11: ⟦lib.close_e_wrap (lib.FrameList.FHyp n h t) ob = lib.GoalData.Imp h (Tactus.Box.mk (lib.close_e_wrap t ob))⟧
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:5128:13 -/ lib.close_e_wrap (lib.FrameList.FHyp n h t) ob = lib.GoalData.Imp h (Tactus.Box.mk (lib.close_e_wrap t.deref ob))⟧
-- leaf 13: ⟦lib.close_e_wrap⟧
-- leaf 14: ⟦lib.GoalData⟧
-- leaf 15: ⟦lib.FrameList⟧

@[reducible] def cert_u_cew_hyp_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cew_hyp_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cew_hyp_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cew_hyp_at_lib_5128_13_1
@[reducible] def cert_u_cew_hyp_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cew_hyp_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cew_hyp_ctx cert_u_cew_hyp_sst) cert_u_cew_hyp_goals = 1 := by decide
