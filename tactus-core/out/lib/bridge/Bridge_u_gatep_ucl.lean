...
-- tactus certificate (stage A) — crate `lib`, fn `u_gatep_ucl`
...
-- leaf 1: ⟦lib.LeafList⟧
-- leaf 2: ⟦t⟧
-- leaf 3: ⟦Tactus.Box lib.FrameList⟧
-- leaf 4: ⟦lib.has_poisoned_hyp pp (lib.FrameList.FUserCloser t) = lib.has_poisoned_hyp pp t⟧
-- leaf 5: ⟦/- @rust:tactus-core/lib.rs:5082:13 -/ lib.has_poisoned_hyp pp (lib.FrameList.FUserCloser t) = lib.has_poisoned_hyp pp t.deref⟧
-- leaf 6: ⟦lib.has_poisoned_hyp⟧
-- leaf 7: ⟦lib.FrameList⟧

@[reducible] def cert_u_gatep_ucl_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_gatep_ucl_sst : lib.StmData :=
...
example : lib.stm_size cert_u_gatep_ucl_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_gatep_ucl_at_lib_5082_13_1
@[reducible] def cert_u_gatep_ucl_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_gatep_ucl_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_gatep_ucl_ctx cert_u_gatep_ucl_sst) cert_u_gatep_ucl_goals = 1 := by decide
