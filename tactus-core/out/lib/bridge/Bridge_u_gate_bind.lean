...
-- tactus certificate (stage A) — crate `lib`, fn `u_gate_bind`
...
-- leaf 9: ⟦lib.has_plain_flet (lib.FrameList.FBind x ty t) = lib.has_plain_flet t⟧
-- leaf 10: ⟦/- @rust:tactus-core/lib.rs:5044:13 -/ lib.has_plain_flet (lib.FrameList.FBind x ty t) = lib.has_plain_flet t.deref⟧
-- leaf 11: ⟦lib.has_plain_flet⟧
-- leaf 12: ⟦lib.FrameList⟧

@[reducible] def cert_u_gate_bind_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_gate_bind_sst : lib.StmData :=
...
example : lib.stm_size cert_u_gate_bind_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_gate_bind_at_lib_5044_13_1
@[reducible] def cert_u_gate_bind_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_gate_bind_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_gate_bind_ctx cert_u_gate_bind_sst) cert_u_gate_bind_goals = 1 := by decide
