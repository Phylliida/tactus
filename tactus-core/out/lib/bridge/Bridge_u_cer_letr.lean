...
-- tactus certificate (stage A) — crate `lib`, fn `u_cer_letr`
...
-- leaf 11: ⟦lib.residue_fold_e (lib.FrameList.FLetR x v t) g = lib.GoalData.Let x v (Tactus.Box.mk (lib.residue_fold_e t g))⟧
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:5199:13 -/ lib.residue_fold_e (lib.FrameList.FLetR x v t) g = lib.GoalData.Let x v (Tactus.Box.mk (lib.residue_fold_e t.deref g))⟧
-- leaf 13: ⟦lib.residue_fold_e⟧
-- leaf 14: ⟦lib.FrameList⟧

@[reducible] def cert_u_cer_letr_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cer_letr_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cer_letr_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cer_letr_at_lib_5199_13_1
@[reducible] def cert_u_cer_letr_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cer_letr_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cer_letr_ctx cert_u_cer_letr_sst) cert_u_cer_letr_goals = 1 := by decide
