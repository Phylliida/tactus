...
-- tactus certificate (stage A) — crate `lib`, fn `u_cce_nil`
...
-- leaf 4: ⟦lib.close_each_e pp f lib.RawExpList.Nil = lib.GoalList.Nil⟧
-- leaf 5: ⟦/- @rust:tactus-core/lib.rs:5217:13 -/ lib.close_each_e pp f lib.RawExpList.Nil = lib.GoalList.Nil⟧
-- leaf 6: ⟦lib.close_each_e⟧
-- leaf 7: ⟦lib.GoalList⟧
-- leaf 8: ⟦lib.RawExpList⟧

@[reducible] def cert_u_cce_nil_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cce_nil_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cce_nil_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cce_nil_at_lib_5217_13_1
@[reducible] def cert_u_cce_nil_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cce_nil_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cce_nil_ctx cert_u_cce_nil_sst) cert_u_cce_nil_goals = 1 := by decide
