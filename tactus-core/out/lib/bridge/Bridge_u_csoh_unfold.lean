...
-- tactus certificate (stage A) — crate `lib`, fn `u_csoh_unfold`
...
-- leaf 10: ⟦∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st l = lib.close_sem_obligs_tel hp he lv f f st l⟧
-- leaf 11: ⟦/- @rust:tactus-core/lib.rs:4843:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_hoist hp he lv f st l = lib.close_sem_obligs_tel hp he lv f f st l⟧

@[reducible] def cert_u_csoh_unfold_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_csoh_unfold_sst : lib.StmData :=
...
example : lib.stm_size cert_u_csoh_unfold_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_csoh_unfold_at_lib_4843_13_1
@[reducible] def cert_u_csoh_unfold_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_csoh_unfold_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_csoh_unfold_ctx cert_u_csoh_unfold_sst) cert_u_csoh_unfold_goals = 1 := by decide
