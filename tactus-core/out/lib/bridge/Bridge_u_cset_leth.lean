...
-- tactus certificate (stage A) — crate `lib`, fn `u_cset_leth`
...
-- leaf 26: ⟦o⟧
-- leaf 27: ⟦lib.RawExp⟧
-- leaf 28: ⟦∀ (st : Int → Int), lib.close_sem_e_tel hp he lv (lib.FrameList.FLetH x ty v en ep t) f0 st o = (∀ (a : Int) (b : Int), lib.close_sem_e_tel hp he lv t f0 (lib.upd (lib.upd st x a) en b) o)⟧
-- leaf 29: ⟦/- @rust:tactus-core/lib.rs:4701:13 -/ ∀ (st : Int → Int), lib.close_sem_e_tel hp he lv (lib.FrameList.FLetH x ty v en ep t) f0 st o = (∀ (a : Int) (b : Int), lib.close_sem_e_tel hp he lv t.deref f0 (lib.upd (lib.upd st x a) en b) o)⟧

@[reducible] def cert_u_cset_leth_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cset_leth_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cset_leth_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cset_leth_at_lib_4701_13_1
@[reducible] def cert_u_cset_leth_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cset_leth_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cset_leth_ctx cert_u_cset_leth_sst) cert_u_cset_leth_goals = 1 := by decide
