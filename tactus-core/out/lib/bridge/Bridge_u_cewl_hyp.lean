...
-- tactus certificate (stage A) — crate `lib`, fn `u_cewl_hyp`
...
-- leaf 0: ⟦n⟧
-- leaf 1: ⟦Int⟧
-- leaf 2: ⟦0 ≤ n ∧ n < 18446744073709551616⟧
-- leaf 3: ⟦h_n_bound⟧
-- leaf 4: ⟦h⟧
-- leaf 5: ⟦0 ≤ h ∧ h < 18446744073709551616⟧
-- leaf 6: ⟦h_h_bound⟧
-- leaf 7: ⟦t⟧
-- leaf 8: ⟦Tactus.Box lib.FrameList⟧
-- leaf 9: ⟦ob⟧
-- leaf 10: ⟦lib.RawExp⟧
-- leaf 11: ⟦lib.close_e_wrap_lead (lib.FrameList.FHyp n h t) ob = lib.GoalData.All n h (Tactus.Box.mk (lib.close_e_wrap_lead t ob))⟧
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:5151:13 -/ lib.close_e_wrap_lead (lib.FrameList.FHyp n h t) ob = lib.GoalData.All n h (Tactus.Box.mk (lib.close_e_wrap_lead t.deref ob))⟧
-- leaf 13: ⟦lib.close_e_wrap_lead⟧
-- leaf 14: ⟦lib.GoalData⟧
-- leaf 15: ⟦lib.FrameList⟧

@[reducible] def cert_u_cewl_hyp_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cewl_hyp_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cewl_hyp_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cewl_hyp_at_lib_5151_13_1
@[reducible] def cert_u_cewl_hyp_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cewl_hyp_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cewl_hyp_ctx cert_u_cewl_hyp_sst) cert_u_cewl_hyp_goals = 1 := by decide
