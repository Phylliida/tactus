...
-- tactus certificate (stage A) — crate `lib`, fn `u_cew_ucl`
...
-- leaf 2: ⟦ob⟧
-- leaf 3: ⟦lib.RawExp⟧
-- leaf 4: ⟦lib.close_e_wrap (lib.FrameList.FUserCloser t) ob = lib.close_e_wrap t ob⟧
-- leaf 5: ⟦/- @rust:tactus-core/lib.rs:5140:13 -/ lib.close_e_wrap (lib.FrameList.FUserCloser t) ob = lib.close_e_wrap t.deref ob⟧
-- leaf 6: ⟦lib.close_e_wrap⟧
-- leaf 7: ⟦lib.GoalData⟧
-- leaf 8: ⟦lib.FrameList⟧

@[reducible] def cert_u_cew_ucl_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cew_ucl_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cew_ucl_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cew_ucl_at_lib_5140_13_1
@[reducible] def cert_u_cew_ucl_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cew_ucl_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cew_ucl_ctx cert_u_cew_ucl_sst) cert_u_cew_ucl_goals = 1 := by decide
