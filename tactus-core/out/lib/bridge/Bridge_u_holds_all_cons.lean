...
-- tactus certificate (stage A) — crate `lib`, fn `u_holds_all_cons`
...
-- leaf 6: ⟦g⟧
-- leaf 7: ⟦Tactus.Box lib.GoalData⟧
-- leaf 8: ⟦t⟧
-- leaf 9: ⟦Tactus.Box lib.GoalList⟧
-- leaf 10: ⟦∀ (st : Int → Int), lib.holds_all hp he lv (lib.GoalList.Cons g t) st = (lib.holds hp he lv g st ∧ lib.holds_all hp he lv t st)⟧
-- leaf 11: ⟦/- @rust:tactus-core/lib.rs:4564:13 -/ ∀ (st : Int → Int), lib.holds_all hp he lv (lib.GoalList.Cons g t) st = (lib.holds hp he lv g.deref st ∧ lib.holds_all hp he lv t.deref st)⟧

@[reducible] def cert_u_holds_all_cons_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_holds_all_cons_sst : lib.StmData :=
...
example : lib.stm_size cert_u_holds_all_cons_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_holds_all_cons_at_lib_4564_13_1
@[reducible] def cert_u_holds_all_cons_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_holds_all_cons_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_holds_all_cons_ctx cert_u_holds_all_cons_sst) cert_u_holds_all_cons_goals = 1 := by decide
