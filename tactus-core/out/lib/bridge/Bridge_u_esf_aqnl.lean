...
-- tactus certificate (stage A) — crate `lib`, fn `u_esf_aqnl`
...
-- leaf 12: ⟦tq⟧
-- leaf 13: ⟦lib.RawExp⟧
-- leaf 14: ⟦∀ (st : Int → Int), lib.exec_safe_f pp hp he lv f (lib.StmData.AssertQueryNl b tq) st = (lib.exec_safe_f pp hp he lv (lib.strip_hyps f) b st ∧ lib.close_sem_e pp hp he lv (lib.frame_after pp (lib.strip_hyps f) b) st tq)⟧
-- leaf 15: ⟦/- @rust:tactus-core/lib.rs:4948:13 -/ ∀ (st : Int → Int), lib.exec_safe_f pp hp he lv f (lib.StmData.AssertQueryNl b tq) st = (lib.exec_safe_f pp hp he lv (lib.strip_hyps f) b.deref st ∧ lib.close_sem_e pp hp he lv (lib.frame_after pp (lib.strip_hyps f) b.deref) st tq)⟧

@[reducible] def cert_u_esf_aqnl_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_esf_aqnl_sst : lib.StmData :=
...
example : lib.stm_size cert_u_esf_aqnl_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_esf_aqnl_at_lib_4948_13_1
@[reducible] def cert_u_esf_aqnl_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_esf_aqnl_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_esf_aqnl_ctx cert_u_esf_aqnl_sst) cert_u_esf_aqnl_goals = 1 := by decide
