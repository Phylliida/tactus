...
-- tactus certificate (stage A) — crate `lib`, fn `u_csew_letr`
...
-- leaf 15: ⟦o⟧
-- leaf 16: ⟦lib.RawExp⟧
-- leaf 17: ⟦∀ (st : Int → Int), lib.close_sem_e_wrap hp he lv (lib.FrameList.FLetR x v t) st o = lib.close_sem_e_wrap hp he lv t (lib.upd st x (lv v st)) o⟧
-- leaf 18: ⟦/- @rust:tactus-core/lib.rs:4623:13 -/ ∀ (st : Int → Int), lib.close_sem_e_wrap hp he lv (lib.FrameList.FLetR x v t) st o = lib.close_sem_e_wrap hp he lv t.deref (lib.upd st x (lv v st)) o⟧

@[reducible] def cert_u_csew_letr_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_csew_letr_sst : lib.StmData :=
...
example : lib.stm_size cert_u_csew_letr_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_csew_letr_at_lib_4623_13_1
@[reducible] def cert_u_csew_letr_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_csew_letr_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_csew_letr_ctx cert_u_csew_letr_sst) cert_u_csew_letr_goals = 1 := by decide
