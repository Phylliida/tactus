...
-- tactus certificate (stage A) — crate `lib`, fn `u_esf_skip`
...
-- leaf 10: ⟦∀ (st : Int → Int), lib.exec_safe_f pp hp he lv f lib.StmData.Skip st = True⟧
-- leaf 11: ⟦/- @rust:tactus-core/lib.rs:5021:13 -/ ∀ (st : Int → Int), lib.exec_safe_f pp hp he lv f lib.StmData.Skip st = True⟧

@[reducible] def cert_u_esf_skip_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_esf_skip_sst : lib.StmData :=
...
example : lib.stm_size cert_u_esf_skip_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_esf_skip_at_lib_5021_13_1
@[reducible] def cert_u_esf_skip_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_esf_skip_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_esf_skip_ctx cert_u_esf_skip_sst) cert_u_esf_skip_goals = 1 := by decide
