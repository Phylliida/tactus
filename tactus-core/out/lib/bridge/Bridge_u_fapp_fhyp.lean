...
-- tactus certificate (stage A) — crate `lib`, fn `u_fapp_fhyp`
...
@[reducible] def cert_u_fapp_fhyp_sst : lib.StmData :=
...
example : lib.goal_count cert_u_fapp_fhyp_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_fapp_fhyp_ctx cert_u_fapp_fhyp_sst) cert_u_fapp_fhyp_goals = 1 := by decide
