...
-- tactus certificate (stage A) — crate `lib`, fn `u_csor_ucl`
...
-- leaf 10: ⟦∀ (st : Int → Int), lib.close_sem_obligs_res hp he lv (lib.FrameList.FUserCloser t) st l = lib.close_sem_obligs_res hp he lv t st l⟧
-- leaf 11: ⟦/- @rust:tactus-core/lib.rs:4913:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_res hp he lv (lib.FrameList.FUserCloser t) st l = lib.close_sem_obligs_res hp he lv t.deref st l⟧

@[reducible] def cert_u_csor_ucl_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_csor_ucl_sst : lib.StmData :=
...
example : lib.stm_size cert_u_csor_ucl_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_csor_ucl_at_lib_4913_13_1
@[reducible] def cert_u_csor_ucl_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_csor_ucl_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_csor_ucl_ctx cert_u_csor_ucl_sst) cert_u_csor_ucl_goals = 1 := by decide
