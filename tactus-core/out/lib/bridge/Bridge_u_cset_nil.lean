...
-- tactus certificate (stage A) — crate `lib`, fn `u_cset_nil`
...
-- leaf 8: ⟦o⟧
-- leaf 9: ⟦lib.RawExp⟧
-- leaf 10: ⟦∀ (st : Int → Int), lib.close_sem_e_tel hp he lv lib.FrameList.FNil f0 st o = lib.close_sem_e_res hp he lv f0 st o⟧
-- leaf 11: ⟦/- @rust:tactus-core/lib.rs:4681:13 -/ ∀ (st : Int → Int), lib.close_sem_e_tel hp he lv lib.FrameList.FNil f0 st o = lib.close_sem_e_res hp he lv f0 st o⟧

@[reducible] def cert_u_cset_nil_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cset_nil_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cset_nil_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cset_nil_at_lib_4681_13_1
@[reducible] def cert_u_cset_nil_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cset_nil_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cset_nil_ctx cert_u_cset_nil_sst) cert_u_cset_nil_goals = 1 := by decide
