...
-- tactus certificate (stage A) — crate `lib`, fn `u_holds_all_nil`
...
-- leaf 6: ⟦∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True⟧
-- leaf 7: ⟦/- @rust:tactus-core/lib.rs:4560:13 -/ ∀ (st : Int → Int), lib.holds_all hp he lv lib.GoalList.Nil st = True⟧

@[reducible] def cert_u_holds_all_nil_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_holds_all_nil_sst : lib.StmData :=
...
example : lib.stm_size cert_u_holds_all_nil_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_holds_all_nil_at_lib_4560_13_1
@[reducible] def cert_u_holds_all_nil_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_holds_all_nil_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_holds_all_nil_ctx cert_u_holds_all_nil_sst) cert_u_holds_all_nil_goals = 1 := by decide
