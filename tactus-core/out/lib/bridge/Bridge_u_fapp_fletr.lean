...
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:6500:13 -/ lib.frame_append (lib.FrameList.FLetR x v t) g = lib.FrameList.FLetR x v (Tactus.Box.mk (lib.frame_append t.deref g))⟧
...
-- goal 0: _tactus_postcondition_u_fapp_fletr_at_lib_6500_13_1
...
example : lib.goals_eq (lib.ref_wp cert_u_fapp_fletr_ctx cert_u_fapp_fletr_sst) cert_u_fapp_fletr_goals = 1 := by decide
