...
-- tactus certificate (stage A) — crate `lib`, fn `u_gapp_nil`
...
-- leaf 0: ⟦b⟧
-- leaf 1: ⟦lib.GoalList⟧
-- leaf 2: ⟦lib.goals_append lib.GoalList.Nil b = b⟧
-- leaf 3: ⟦/- @rust:tactus-core/lib.rs:5224:13 -/ lib.goals_append lib.GoalList.Nil b = b⟧
-- leaf 4: ⟦lib.goals_append⟧

@[reducible] def cert_u_gapp_nil_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_gapp_nil_sst : lib.StmData :=
...
example : lib.stm_size cert_u_gapp_nil_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_gapp_nil_at_lib_5224_13_1
@[reducible] def cert_u_gapp_nil_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_gapp_nil_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_gapp_nil_ctx cert_u_gapp_nil_sst) cert_u_gapp_nil_goals = 1 := by decide
