...
-- tactus certificate (stage A) — crate `lib`, fn `u_gateu_ucl`
...
-- leaf 2: ⟦lib.has_user_closer (lib.FrameList.FUserCloser t) = 1⟧
-- leaf 3: ⟦/- @rust:tactus-core/lib.rs:5105:13 -/ lib.has_user_closer (lib.FrameList.FUserCloser t) = 1⟧
-- leaf 4: ⟦lib.has_user_closer⟧
-- leaf 5: ⟦lib.FrameList⟧

@[reducible] def cert_u_gateu_ucl_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_gateu_ucl_sst : lib.StmData :=
...
example : lib.stm_size cert_u_gateu_ucl_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_gateu_ucl_at_lib_5105_13_1
@[reducible] def cert_u_gateu_ucl_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_gateu_ucl_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_gateu_ucl_ctx cert_u_gateu_ucl_sst) cert_u_gateu_ucl_goals = 1 := by decide
