...
-- tactus certificate (stage A) — crate `lib`, fn `u_cce_cons`
...
-- leaf 4: ⟦h⟧
-- leaf 5: ⟦Tactus.Box lib.RawExp⟧
-- leaf 6: ⟦t⟧
-- leaf 7: ⟦Tactus.Box lib.RawExpList⟧
-- leaf 8: ⟦lib.close_each_e pp f (lib.RawExpList.Cons h t) = lib.GoalList.Cons (Tactus.Box.mk (lib.close_e pp f h)) (Tactus.Box.mk (lib.close_each_e pp f t))⟧
-- leaf 9: ⟦/- @rust:tactus-core/lib.rs:5220:13 -/ lib.close_each_e pp f (lib.RawExpList.Cons h t) = lib.GoalList.Cons (Tactus.Box.mk (lib.close_e pp f h.deref)) (Tactus.Box.mk (lib.close_each_e pp f t.deref))⟧
-- leaf 10: ⟦lib.close_each_e⟧
-- leaf 11: ⟦lib.GoalList⟧
-- leaf 12: ⟦lib.RawExpList⟧

@[reducible] def cert_u_cce_cons_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cce_cons_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cce_cons_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cce_cons_at_lib_5220_13_1
@[reducible] def cert_u_cce_cons_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cce_cons_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cce_cons_ctx cert_u_cce_cons_sst) cert_u_cce_cons_goals = 1 := by decide
