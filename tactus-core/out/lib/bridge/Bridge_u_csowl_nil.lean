...
-- tactus certificate (stage A) — crate `lib`, fn `u_csowl_nil`
...
-- leaf 6: ⟦l⟧
-- leaf 7: ⟦lib.RawExpList⟧
-- leaf 8: ⟦∀ (st : Int → Int), lib.close_sem_obligs_wrap_lead hp he lv lib.FrameList.FNil st l = lib.obligs_safe he l st⟧
-- leaf 9: ⟦/- @rust:tactus-core/lib.rs:4805:13 -/ ∀ (st : Int → Int), lib.close_sem_obligs_wrap_lead hp he lv lib.FrameList.FNil st l = lib.obligs_safe he l st⟧

@[reducible] def cert_u_csowl_nil_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_csowl_nil_sst : lib.StmData :=
...
example : lib.stm_size cert_u_csowl_nil_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_csowl_nil_at_lib_4805_13_1
@[reducible] def cert_u_csowl_nil_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_csowl_nil_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_csowl_nil_ctx cert_u_csowl_nil_sst) cert_u_csowl_nil_goals = 1 := by decide
