...
-- tactus certificate (stage A) — crate `lib`, fn `u_csewl_hyp`
...
-- leaf 15: ⟦o⟧
-- leaf 16: ⟦lib.RawExp⟧
-- leaf 17: ⟦∀ (st : Int → Int), lib.close_sem_e_wrap_lead hp he lv (lib.FrameList.FHyp n h t) st o = (∀ (m : Int), lib.close_sem_e_wrap_lead hp he lv t (lib.upd st n m) o)⟧
-- leaf 18: ⟦/- @rust:tactus-core/lib.rs:4646:13 -/ ∀ (st : Int → Int), lib.close_sem_e_wrap_lead hp he lv (lib.FrameList.FHyp n h t) st o = (∀ (m : Int), lib.close_sem_e_wrap_lead hp he lv t.deref (lib.upd st n m) o)⟧

@[reducible] def cert_u_csewl_hyp_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_csewl_hyp_sst : lib.StmData :=
...
example : lib.stm_size cert_u_csewl_hyp_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_csewl_hyp_at_lib_4646_13_1
@[reducible] def cert_u_csewl_hyp_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_csewl_hyp_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_csewl_hyp_ctx cert_u_csewl_hyp_sst) cert_u_csewl_hyp_goals = 1 := by decide
