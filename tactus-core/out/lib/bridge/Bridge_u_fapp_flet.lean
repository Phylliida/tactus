...
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:6496:13 -/ lib.frame_append (lib.FrameList.FLet x v t) g = lib.FrameList.FLet x v (Tactus.Box.mk (lib.frame_append t.deref g))⟧
...
-- goal 0: _tactus_postcondition_u_fapp_flet_at_lib_6496_13_1
