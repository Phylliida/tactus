...
-- tactus certificate (stage A) — crate `lib`, fn `u_cet_letr`
...
-- leaf 11: ⟦lib.close_e_tel (lib.FrameList.FLetR x v t) g = lib.close_e_tel t g⟧
-- leaf 12: ⟦/- @rust:tactus-core/lib.rs:5190:13 -/ lib.close_e_tel (lib.FrameList.FLetR x v t) g = lib.close_e_tel t.deref g⟧
-- leaf 13: ⟦lib.close_e_tel⟧
-- leaf 14: ⟦lib.FrameList⟧

@[reducible] def cert_u_cet_letr_ctx : lib.FnCtxData :=
...
@[reducible] def cert_u_cet_letr_sst : lib.StmData :=
...
example : lib.stm_size cert_u_cet_letr_sst = 2 := by decide

-- ── production goals (N3b) ──────────────────────────────────
-- goal 0: _tactus_postcondition_u_cet_letr_at_lib_5190_13_1
@[reducible] def cert_u_cet_letr_goals : lib.GoalList :=
...
example : lib.goal_count cert_u_cet_letr_goals = 1 := by decide

-- ── W4a in-gate bridge (bootstrap-38) ──
set_option maxRecDepth 8000
example : lib.goals_eq (lib.ref_wp cert_u_cet_letr_ctx cert_u_cet_letr_sst) cert_u_cet_letr_goals = 1 := by decide
