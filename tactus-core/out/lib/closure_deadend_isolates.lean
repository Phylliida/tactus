...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_precondition_closure_deadend_isolates_at_lib_4412_5_9 (q : Int) (h_q_bound : 0 ≤ q ∧ q < 18446744073709551616) (h : Int) (h_h_bound : 0 ≤ h ∧ h < 18446744073709551616) (obl : lib.RawExp) (tmp__1 : lib.FrameList) (_h_tmp__1_hoist1 : tmp__1 = lib.FrameList.FNil) (tmp__2 : lib.StmData) (_h_tmp__2_hoist1 : tmp__2 = lib.StmData.DeadEnd (Tactus.Box.mk (lib.StmData.Assume q))) (tmp__3 : lib.StmData) (_h_tmp__3_hoist1 : tmp__3 = lib.StmData.Assert obl h) (_tactus_ret_1 : Unit) (_h_hoist_1 : lib.wp_stm tmp__1 (lib.StmData.Seq (Tactus.Box.mk tmp__2) (Tactus.Box.mk tmp__3)) = lib.goals_append (lib.wp_stm tmp__1 tmp__2) (lib.wp_stm (lib.frame_after tmp__1 tmp__2) tmp__3)) (tmp__4 : lib.FrameList) (_h_tmp__4_hoist1 : tmp__4 = lib.FrameList.FNil) (tmp__5 : lib.StmData) (_h_tmp__5_hoist1 : tmp__5 = lib.StmData.Assume q) (_tactus_ret_2 : Unit) (_h_hoist_2 : lib.wp_stm tmp__4 (lib.StmData.DeadEnd (Tactus.Box.mk tmp__5)) = lib.wp_stm tmp__4 tmp__5) (tmp__6 : lib.FrameList) (_h_tmp__6_hoist1 : tmp__6 = lib.FrameList.FNil) (_tactus_ret_3 : Unit) (_h_hoist_3 : lib.wp_stm tmp__6 (lib.StmData.Assume q) = lib.GoalList.Nil) (tmp__7 : lib.FrameList) (_h_tmp__7_hoist1 : tmp__7 = lib.FrameList.FNil) (tmp__8 : lib.StmData) (_h_tmp__8_hoist1 : tmp__8 = lib.StmData.Assume q) (_tactus_ret_4 : Unit) (_h_hoist_4 : lib.frame_after tmp__7 (lib.StmData.DeadEnd (Tactus.Box.mk tmp__8)) = tmp__7) (tmp__9 : lib.FrameList) (_h_tmp__9_hoist1 : tmp__9 = lib.FrameList.FNil) (_tactus_ret_5 : Unit) (_h_hoist_5 : lib.wp_stm tmp__9 (lib.StmData.Assert obl h) = lib.GoalList.Cons (Tactus.Box.mk (lib.close_e tmp__9 obl)) (Tactus.Box.mk lib.GoalList.Nil)) (tmp__10 : lib.GoalList) (_h_tmp__10_hoist1 : tmp__10 = lib.wp_stm lib.FrameList.FNil (lib.StmData.Assert obl h)) (_tactus_ret_6 : Unit) (_h_hoist_6 : lib.goals_append lib.GoalList.Nil tmp__10 = tmp__10) (_tactus_ret_7 : Unit) (_h_hoist_7 : lib.has_plain_flet lib.FrameList.FNil = 0) (tmp__11 : lib.FrameList) (_h_tmp__11_hoist1 : tmp__11 = lib.FrameList.FNil) :
    /- @rust:lib.rs:4412:5 -/ ¬(lib.has_plain_flet tmp__11 = 1) := by
...
theorem _tactus_postcondition_closure_deadend_isolates_at_lib_4398_13_11 (q : Int) (h_q_bound : 0 ≤ q ∧ q < 18446744073709551616) (h : Int) (h_h_bound : 0 ≤ h ∧ h < 18446744073709551616) (obl : lib.RawExp) (tmp__1 : lib.FrameList) (_h_tmp__1_hoist1 : tmp__1 = lib.FrameList.FNil) (tmp__2 : lib.StmData) (_h_tmp__2_hoist1 : tmp__2 = lib.StmData.DeadEnd (Tactus.Box.mk (lib.StmData.Assume q))) (tmp__3 : lib.StmData) (_h_tmp__3_hoist1 : tmp__3 = lib.StmData.Assert obl h) (_tactus_ret_1 : Unit) (_h_hoist_1 : lib.wp_stm tmp__1 (lib.StmData.Seq (Tactus.Box.mk tmp__2) (Tactus.Box.mk tmp__3)) = lib.goals_append (lib.wp_stm tmp__1 tmp__2) (lib.wp_stm (lib.frame_after tmp__1 tmp__2) tmp__3)) (tmp__4 : lib.FrameList) (_h_tmp__4_hoist1 : tmp__4 = lib.FrameList.FNil) (tmp__5 : lib.StmData) (_h_tmp__5_hoist1 : tmp__5 = lib.StmData.Assume q) (_tactus_ret_2 : Unit) (_h_hoist_2 : lib.wp_stm tmp__4 (lib.StmData.DeadEnd (Tactus.Box.mk tmp__5)) = lib.wp_stm tmp__4 tmp__5) (tmp__6 : lib.FrameList) (_h_tmp__6_hoist1 : tmp__6 = lib.FrameList.FNil) (_tactus_ret_3 : Unit) (_h_hoist_3 : lib.wp_stm tmp__6 (lib.StmData.Assume q) = lib.GoalList.Nil) (tmp__7 : lib.FrameList) (_h_tmp__7_hoist1 : tmp__7 = lib.FrameList.FNil) (tmp__8 : lib.StmData) (_h_tmp__8_hoist1 : tmp__8 = lib.StmData.Assume q) (_tactus_ret_4 : Unit) (_h_hoist_4 : lib.frame_after tmp__7 (lib.StmData.DeadEnd (Tactus.Box.mk tmp__8)) = tmp__7) (tmp__9 : lib.FrameList) (_h_tmp__9_hoist1 : tmp__9 = lib.FrameList.FNil) (_tactus_ret_5 : Unit) (_h_hoist_5 : lib.wp_stm tmp__9 (lib.StmData.Assert obl h) = lib.GoalList.Cons (Tactus.Box.mk (lib.close_e tmp__9 obl)) (Tactus.Box.mk lib.GoalList.Nil)) (tmp__10 : lib.GoalList) (_h_tmp__10_hoist1 : tmp__10 = lib.wp_stm lib.FrameList.FNil (lib.StmData.Assert obl h)) (_tactus_ret_6 : Unit) (_h_hoist_6 : lib.goals_append lib.GoalList.Nil tmp__10 = tmp__10) (_tactus_ret_7 : Unit) (_h_hoist_7 : lib.has_plain_flet lib.FrameList.FNil = 0) (tmp__11 : lib.FrameList) (_h_tmp__11_hoist1 : tmp__11 = lib.FrameList.FNil) (_tactus_ret_8 : Unit) (_h_hoist_8 : lib.close_e tmp__11 obl = lib.close_e_hoist tmp__11 obl) (_tactus_ret_10 : Unit) (_h_hoist_9 : lib.close_e_hoist lib.FrameList.FNil obl = lib.GoalData.LeafE (lib.render_exp obl)) :
    /- @rust:lib.rs:4398:13 -/ lib.wp_stm lib.FrameList.FNil (lib.StmData.Seq (Tactus.Box.mk (lib.StmData.DeadEnd (Tactus.Box.mk (lib.StmData.Assume q)))) (Tactus.Box.mk (lib.StmData.Assert obl h))) = lib.GoalList.Cons (Tactus.Box.mk (lib.GoalData.LeafE (lib.render_exp obl))) (Tactus.Box.mk lib.GoalList.Nil) := by
