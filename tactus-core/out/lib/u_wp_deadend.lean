...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_wp_deadend_at_lib_3755_13_1 (f : lib.FrameList) (b : Tactus.Box lib.StmData) :
    /- @rust:lib.rs:3755:13 -/ lib.wp_stm f (lib.StmData.DeadEnd b) = lib.wp_stm f b.deref := by
