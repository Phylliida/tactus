...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_fa_assume_at_lib_4277_13_1 (f : lib.FrameList) (e : Int) (h_e_bound : 0 ≤ e ∧ e < 18446744073709551616) :
    /- @rust:lib.rs:4277:13 -/ lib.frame_after f (lib.StmData.Assume e) = lib.frame_append f (lib.FrameList.FHyp 0 e (Tactus.Box.mk lib.FrameList.FNil)) := by
