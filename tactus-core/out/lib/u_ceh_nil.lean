...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_ceh_nil_at_lib_3712_13_1 (ob : lib.RawExp) :
    /- @rust:lib.rs:3712:13 -/ lib.close_e_hoist lib.FrameList.FNil ob = lib.GoalData.LeafE (lib.render_exp ob) := by
