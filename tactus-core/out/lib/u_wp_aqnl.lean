...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_wp_aqnl_at_lib_3758_13_1 (f : lib.FrameList) (b : Tactus.Box lib.StmData) :
    /- @rust:lib.rs:3758:13 -/ lib.wp_stm f (lib.StmData.AssertQueryNl b) = lib.wp_stm (lib.strip_hyps f) b.deref := by
