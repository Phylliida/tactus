...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_fa_seq_at_lib_4284_13_1 (f : lib.FrameList) (a : Tactus.Box lib.StmData) (b : Tactus.Box lib.StmData) :
    /- @rust:lib.rs:4284:13 -/ lib.frame_after f (lib.StmData.Seq a b) = lib.frame_after (lib.frame_after f a.deref) b.deref := by
