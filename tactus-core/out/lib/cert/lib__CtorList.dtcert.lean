...
-- tactus defs-layer certificate (W7d) — crate `lib`, datatype `lib.CtorList`
...
def cert_lib__CtorList_raw : lib.RawDt :=
...
def cert_lib__CtorList_dtdata : lib.DtData :=
...
example : lib.dt_eq (lib.render_dt cert_lib__CtorList_raw) cert_lib__CtorList_dtdata = 1 := by decide
