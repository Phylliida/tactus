...
theorem lib.amended_shapes_kernel_compute :
  ...
  decide
theorem _tactus_postcondition_u_wp_assume_at_lib_3746_13_1 (f : lib.FrameList) (e : Int) (h_e_bound : 0 ≤ e ∧ e < 18446744073709551616) :
    /- @rust:lib.rs:3746:13 -/ lib.wp_stm f (lib.StmData.Assume e) = lib.GoalList.Nil := by
