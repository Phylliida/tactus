...
- [2026-05-11](poems/2026-05-11.md) — the name no one called (latent wrongness vs first-use surfacing; coverage as scheduling, not finding); after the loud one (task-shape is in the task, not the day)
